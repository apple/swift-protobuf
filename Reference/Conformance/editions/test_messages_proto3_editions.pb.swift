...
struct ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3: @unchecked Sendable {
  ...
  var optionalNestedMessage: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage {
    get {return _storage._optionalNestedMessage ?? ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage()}
  ...
  var optionalForeignMessage: ProtobufTestMessages_Editions_Proto3_ForeignMessage {
    get {return _storage._optionalForeignMessage ?? ProtobufTestMessages_Editions_Proto3_ForeignMessage()}
  ...
  var recursiveMessage: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3 {
    get {return _storage._recursiveMessage ?? ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3()}
  ...
  var mapStringNestedMessage: Dictionary<String,ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage> {
    get {return _storage._mapStringNestedMessage}
    set {_uniqueStorage()._mapStringNestedMessage = newValue}
  }

  var mapStringForeignMessage: Dictionary<String,ProtobufTestMessages_Editions_Proto3_ForeignMessage> {
    get {return _storage._mapStringForeignMessage}
    set {_uniqueStorage()._mapStringForeignMessage = newValue}
  }

  var mapStringNestedEnum: Dictionary<String,ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedEnum> {
    get {return _storage._mapStringNestedEnum}
    set {_uniqueStorage()._mapStringNestedEnum = newValue}
  }

  var mapStringForeignEnum: Dictionary<String,ProtobufTestMessages_Editions_Proto3_ForeignEnum> {
  ...
  var oneofNestedMessage: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage {
    get {
      ...
      return ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage()
    }
  ...
  struct NestedMessage: @unchecked Sendable {
    ...
    var corecursive: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3 {
      get {return _storage._corecursive ?? ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3()}
...
extension ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _optionalNestedMessage: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage? = nil
    var _optionalForeignMessage: ProtobufTestMessages_Editions_Proto3_ForeignMessage? = nil
    var _optionalNestedEnum: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedEnum = .foo
    var _optionalForeignEnum: ProtobufTestMessages_Editions_Proto3_ForeignEnum = .foreignFoo
    var _optionalAliasedEnum: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.AliasedEnum = .aliasFoo
    var _optionalStringPiece: String = String()
    var _optionalCord: String = String()
    var _recursiveMessage: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3? = nil
    ...
    var _repeatedNestedMessage: [ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage] = []
    var _repeatedForeignMessage: [ProtobufTestMessages_Editions_Proto3_ForeignMessage] = []
    var _repeatedNestedEnum: [ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedEnum] = []
    var _repeatedForeignEnum: [ProtobufTestMessages_Editions_Proto3_ForeignEnum] = []
    ...
    var _packedNestedEnum: [ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedEnum] = []
    ...
    var _unpackedNestedEnum: [ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedEnum] = []
    ...
    var _mapStringNestedMessage: Dictionary<String,ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage> = [:]
    var _mapStringForeignMessage: Dictionary<String,ProtobufTestMessages_Editions_Proto3_ForeignMessage> = [:]
    var _mapStringNestedEnum: Dictionary<String,ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedEnum> = [:]
    var _mapStringForeignEnum: Dictionary<String,ProtobufTestMessages_Editions_Proto3_ForeignEnum> = [:]
    var _oneofField: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.OneOf_OneofField?
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 71: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage>.self, value: &_storage._mapStringNestedMessage) }()
        case 72: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto3_ForeignMessage>.self, value: &_storage._mapStringForeignMessage) }()
        case 73: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedEnum>.self, value: &_storage._mapStringNestedEnum) }()
        case 74: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto3_ForeignEnum>.self, value: &_storage._mapStringForeignEnum) }()
        ...
        case 112: try {
          var v: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage?
        ...
        case 119: try {
          var v: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedEnum?
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._mapStringNestedMessage.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage>.self, value: _storage._mapStringNestedMessage, fieldNumber: 71)
      }
      if !_storage._mapStringForeignMessage.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto3_ForeignMessage>.self, value: _storage._mapStringForeignMessage, fieldNumber: 72)
      }
      if !_storage._mapStringNestedEnum.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedEnum>.self, value: _storage._mapStringNestedEnum, fieldNumber: 73)
      }
      if !_storage._mapStringForeignEnum.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto3_ForeignEnum>.self, value: _storage._mapStringForeignEnum, fieldNumber: 74)
      }
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3, rhs: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3) -> Bool {
...
extension ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.AliasedEnum: SwiftProtobuf._ProtoNameProviding {
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{0}ALIAS_FOO\u{0}\u{1}\u{1}ALIAS_BAR\u{0}\u{4}\u{2}ALIAS_BAZ\u{0}\u{3}MOO\u{0}moo\u{0}bAz\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
}
...
extension ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage, rhs: ProtobufTestMessages_Editions_Proto3_TestAllTypesProto3.NestedMessage) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension ProtobufTestMessages_Editions_Proto3_ForeignMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto3_ForeignMessage, rhs: ProtobufTestMessages_Editions_Proto3_ForeignMessage) -> Bool {
...
extension ProtobufTestMessages_Editions_Proto3_NullHypothesisProto3: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto3_NullHypothesisProto3, rhs: ProtobufTestMessages_Editions_Proto3_NullHypothesisProto3) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension ProtobufTestMessages_Editions_Proto3_EnumOnlyProto3: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto3_EnumOnlyProto3, rhs: ProtobufTestMessages_Editions_Proto3_EnumOnlyProto3) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
