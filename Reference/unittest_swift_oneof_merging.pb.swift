    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 111...114:
          ...
          _storage._oneofField = try SwiftUnittest_TestMessage.OneOf_OneofField(byDecodingFrom: &decoder, fieldNumber: fieldNumber)
        default: break
        }
      }
    }
...
extension SwiftUnittest_TestMessage.OneOf_OneofField {
  fileprivate init?<T: SwiftProtobuf.Decoder>(byDecodingFrom decoder: inout T, fieldNumber: Int) throws {
    ...
    case 112:
      var value: SwiftUnittest_TestMessage.NestedMessage?
