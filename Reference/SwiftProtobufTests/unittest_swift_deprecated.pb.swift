...
enum SwiftProtoTesting_Deprecated_MyEnum: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  case one = 1
...
enum SwiftProtoTesting_Deprecated_MyEnum2: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  case one = 1
  case two = 2
  case three = 3
...
extension SwiftProtoTesting_Deprecated_MyEnum: SwiftProtobuf._ProtoNameProviding {
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{1}MYENUM_ONE\u{0}\u{1}\u{2}MYENUM_TWO\u{0}\u{1}\u{3}MYENUM_THREE\u{0}"
...
extension SwiftProtoTesting_Deprecated_MyEnum2: SwiftProtobuf._ProtoNameProviding {
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{1}MYENUM2_ONE\u{0}\u{1}\u{2}MYENUM2_TWO\u{0}\u{1}\u{3}MYENUM2_THREE\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
}
...
extension SwiftProtoTesting_Deprecated_MyMsg: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{2}\u{1}string_field\u{0}\u{2}\u{2}int_field\u{0}\u{2}\u{3}fixed_field\u{0}\u{2}\u{4}msg_field\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
