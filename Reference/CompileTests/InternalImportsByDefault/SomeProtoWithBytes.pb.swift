...
public nonisolated struct SomeProtoWithBytes: Sendable {
...
nonisolated extension SomeProtoWithBytes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "SomeProtoWithBytes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\u{2}someBytes\0\u{4}b\u{1}ext_str\0")
