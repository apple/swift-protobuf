...
public struct SomeProtoWithBytes: Sendable {
...
extension SomeProtoWithBytes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{2}someBytes\u{0}\u{2}d\u{1}ext_str\u{0}"
