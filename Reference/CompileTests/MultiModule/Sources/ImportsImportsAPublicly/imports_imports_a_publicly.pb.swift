...
public nonisolated struct ImportsImportsAPublicly: @unchecked Swift.Sendable {
...
nonisolated extension ImportsImportsAPublicly: SwiftProtobuf.GeneratedMessage {
  private static let _protobuf_messageSchemaString: Swift.StaticString = "\0\u{8}\0\0\u{2}\0\0\0\0\0\u{2}\0\0\u{1}\0\0\0\0\0\0\0\0\u{1}\0\0\0\0\0\0\0\0\u{15}\0\0\0\0\0\00\0\0\u{2}\0\u{b}\u{16}\0\0\0\0\u{4}\0\0\u{1}\0\u{1}\0\u{e}\u{17}\0ImportsImportsAPublicly"
