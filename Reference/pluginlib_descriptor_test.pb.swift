...
enum SDTTopLevelEnum: SwiftProtobufCore.Enum {
...
struct SDTTopLevelMessage {
  ...
  enum SubEnum: SwiftProtobufCore.Enum {
    typealias RawValue = Int
    case subValue0 // = 0
    case subValue1 // = 1
    case subValue2 // = 2
...
struct SDTExternalRefs {
  ...
  var desc: SwiftProtobufCore.Google_Protobuf_DescriptorProto {
    get {return _storage._desc ?? SwiftProtobufCore.Google_Protobuf_DescriptorProto()}
...
let SDTPluginlibDescriptorTest_Extensions: SwiftProtobufCore.SimpleExtensionMap = [
...
let SDTExtensions_ext_str = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufString>, SwiftProtobufCore.Google_Protobuf_FieldOptions>(
...
extension SDTScoperForExt {
  enum Extensions {
    static let ext_enum = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalEnumExtensionField<SDTTopLevelEnum>, SwiftProtobufCore.Google_Protobuf_MessageOptions>(
      _protobuf_fieldNumber: 99001,
      fieldName: "swift_descriptor_test.ScoperForExt.ext_enum"
    )

    static let ext_msg = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalMessageExtensionField<SDTTopLevelMessage2>, SwiftProtobufCore.Google_Protobuf_MessageOptions>(
...
extension SDTTopLevelEnum: SwiftProtobufCore._ProtoNameProviding {
...
extension SDTTopLevelMessage: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
...
extension SDTTopLevelMessage.SubEnum: SwiftProtobufCore._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobufCore._NameMap = [
...
extension SDTTopLevelMessage.SubMessage: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
...
extension SDTTopLevelMessage2: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
...
extension SDTExternalRefs: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _desc: SwiftProtobufCore.Google_Protobuf_DescriptorProto? = nil
...
extension SDTScoperForExt: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
...
extension SDTProto2MessageForPresence: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
