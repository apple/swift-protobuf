...
struct ProtobufUnittest_SwiftJSONTest {
  ...
  var repeatedNullValue: [SwiftProtobufCore.Google_Protobuf_NullValue] = []
...
extension ProtobufUnittest_SwiftJSONTest: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
