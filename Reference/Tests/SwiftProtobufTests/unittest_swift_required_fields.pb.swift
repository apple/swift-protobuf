...
struct SwiftProtoTesting_RequiredWithNested: @unchecked Swift.Sendable {
  ...
  mutating func clearNested() { _uniqueStorage().clearValue(atIndex: 0, type: SwiftProtoTesting_NestedRequired.self, hasBit: (0, 1)) }
...
struct SwiftProtoTesting_NoneRequired: @unchecked Swift.Sendable {
  ...
  var hasOpt2: Swift.Bool { _storage.isPresent(hasBit: (0, 2)) }
  /// Clears the value of `opt2`. Subsequent reads from it will return its default value.
  mutating func clearOpt2() { _uniqueStorage().clearValue(atIndex: 0, type: SwiftProtoTesting_NestedNoneRequired.self, hasBit: (0, 2)) }
...
struct SwiftProtoTesting_NoneRequiredButNestedRequired: @unchecked Swift.Sendable {
  ...
  var hasOpt2: Swift.Bool { _storage.isPresent(hasBit: (0, 2)) }
  /// Clears the value of `opt2`. Subsequent reads from it will return its default value.
  mutating func clearOpt2() { _uniqueStorage().clearValue(atIndex: 0, type: SwiftProtoTesting_NestedRequired.self, hasBit: (0, 2)) }
...
extension SwiftProtoTesting_MapWithNestedRequiredValues: SwiftProtobuf.GeneratedMessage {
  ...
  private static let _protobuf_mapEntrySchema_Map1Entry_string: Swift.StaticString = "\0\u{8}\0@\u{2}\0\0\0\0\0\u{2}\0\0\u{3}\0\0\0\0\0\0\0\0\u{1}\0\0\0\0\0\0\0\0\u{1}\0\0\0\0\u{4}\0\0\0\0\0\0\u{5}\u{2}\0\0\0\0\0\00\u{1}\0\u{1}\0\u{b}9\0swift_proto_testing.MapWithNestedRequiredValues.Map1Entry"
