...
struct ProtobufTestMessages_Proto2_GroupField {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension ProtobufTestMessages_Proto2_TestAllTypesProto2.MultiWordGroupField: @unchecked Sendable {}
...
extension ProtobufTestMessages_Proto2_GroupField: @unchecked Sendable {}
