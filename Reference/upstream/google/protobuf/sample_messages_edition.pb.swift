...
struct ProtobufTestMessages_Edition_TestAllTypesEdition: SwiftProtobuf.ExtensibleMessage, @unchecked Sendable {
  ...
  var optionalNestedMessage: ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage {
    get {return _storage._optionalNestedMessage ?? ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage()}
  ...
  var optionalForeignMessage: ProtobufTestMessages_Edition_ForeignMessageEdition {
    get {return _storage._optionalForeignMessage ?? ProtobufTestMessages_Edition_ForeignMessageEdition()}
  ...
  var recursiveMessage: ProtobufTestMessages_Edition_TestAllTypesEdition {
    get {return _storage._recursiveMessage ?? ProtobufTestMessages_Edition_TestAllTypesEdition()}
  ...
  var mapStringNestedMessage: Dictionary<String,ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage> {
    get {return _storage._mapStringNestedMessage}
    set {_uniqueStorage()._mapStringNestedMessage = newValue}
  }

  var mapStringForeignMessage: Dictionary<String,ProtobufTestMessages_Edition_ForeignMessageEdition> {
    get {return _storage._mapStringForeignMessage}
    set {_uniqueStorage()._mapStringForeignMessage = newValue}
  }

  var mapStringNestedEnum: Dictionary<String,ProtobufTestMessages_Edition_TestAllTypesEdition.NestedEnum> {
    get {return _storage._mapStringNestedEnum}
    set {_uniqueStorage()._mapStringNestedEnum = newValue}
  }

  var mapStringForeignEnum: Dictionary<String,ProtobufTestMessages_Edition_ForeignEnumEdition> {
  ...
  var oneofNestedMessage: ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage {
    get {
      ...
      return ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage()
    }
  ...
  var data: ProtobufTestMessages_Edition_TestAllTypesEdition.DataMessage {
    get {return _storage._data ?? ProtobufTestMessages_Edition_TestAllTypesEdition.DataMessage()}
  ...
  struct NestedMessage: @unchecked Sendable {
    ...
    var corecursive: ProtobufTestMessages_Edition_TestAllTypesEdition {
      get {return _storage._corecursive ?? ProtobufTestMessages_Edition_TestAllTypesEdition()}
...
struct ProtobufTestMessages_Edition_ForeignMessageEdition: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct ProtobufTestMessages_Edition_UnknownToTestAllTypes: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var nestedMessage: ProtobufTestMessages_Edition_ForeignMessageEdition {
    get {return _nestedMessage ?? ProtobufTestMessages_Edition_ForeignMessageEdition()}
  ...
  var optionalGroup: ProtobufTestMessages_Edition_UnknownToTestAllTypes.OptionalGroup {
    get {return _optionalGroup ?? ProtobufTestMessages_Edition_UnknownToTestAllTypes.OptionalGroup()}
  ...
  fileprivate var _nestedMessage: ProtobufTestMessages_Edition_ForeignMessageEdition? = nil
  fileprivate var _optionalGroup: ProtobufTestMessages_Edition_UnknownToTestAllTypes.OptionalGroup? = nil
  fileprivate var _optionalBool: Bool? = nil
}

struct ProtobufTestMessages_Edition_NullHypothesisEdition: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct ProtobufTestMessages_Edition_EnumOnlyEdition: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct ProtobufTestMessages_Edition_OneStringEdition: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct ProtobufTestMessages_Edition_ProtoWithKeywords: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct ProtobufTestMessages_Edition_TestAllRequiredTypesEdition: SwiftProtobuf.ExtensibleMessage, @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var requiredNestedMessage: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.NestedMessage {
    get {return _storage._requiredNestedMessage ?? ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.NestedMessage()}
  ...
  var requiredForeignMessage: ProtobufTestMessages_Edition_ForeignMessageEdition {
    get {return _storage._requiredForeignMessage ?? ProtobufTestMessages_Edition_ForeignMessageEdition()}
  ...
  var recursiveMessage: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition {
    get {return _storage._recursiveMessage ?? ProtobufTestMessages_Edition_TestAllRequiredTypesEdition()}
    set {_uniqueStorage()._recursiveMessage = newValue}
  }
  /// Returns true if `recursiveMessage` has been explicitly set.
  var hasRecursiveMessage: Bool {return _storage._recursiveMessage != nil}
  ...
  var optionalRecursiveMessage: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition {
    get {return _storage._optionalRecursiveMessage ?? ProtobufTestMessages_Edition_TestAllRequiredTypesEdition()}
  ...
  var data: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.DataMessage {
    get {return _storage._data ?? ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.DataMessage()}
    set {_uniqueStorage()._data = newValue}
  }
  /// Returns true if `data` has been explicitly set.
  var hasData: Bool {return _storage._data != nil}
  ...
  struct NestedMessage: @unchecked Sendable {
    ...
    var corecursive: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition {
      get {return _storage._corecursive ?? ProtobufTestMessages_Edition_TestAllRequiredTypesEdition()}
      set {_uniqueStorage()._corecursive = newValue}
    }
    /// Returns true if `corecursive` has been explicitly set.
    var hasCorecursive: Bool {return _storage._corecursive != nil}
    ...
    var optionalCorecursive: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition {
      get {return _storage._optionalCorecursive ?? ProtobufTestMessages_Edition_TestAllRequiredTypesEdition()}
...
extension ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrect {
  ...
  var ProtobufTestMessages_Edition_TestAllRequiredTypesEdition_MessageSetCorrectExtension1_messageSetExtension: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension1 {
    get {return getExtensionValue(ext: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension1.Extensions.message_set_extension) ?? ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension1()}
    set {setExtensionValue(ext: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension1.Extensions.message_set_extension, value: newValue)}
  }
  ...
  var hasProtobufTestMessages_Edition_TestAllRequiredTypesEdition_MessageSetCorrectExtension1_messageSetExtension: Bool {
    return hasExtensionValue(ext: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension1.Extensions.message_set_extension)
  }
  ...
  var ProtobufTestMessages_Edition_TestAllRequiredTypesEdition_MessageSetCorrectExtension2_messageSetExtension: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension2 {
    get {return getExtensionValue(ext: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension2.Extensions.message_set_extension) ?? ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension2()}
    set {setExtensionValue(ext: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension2.Extensions.message_set_extension, value: newValue)}
  }
  ...
  /// has been explicitly set.
  var hasProtobufTestMessages_Edition_TestAllRequiredTypesEdition_MessageSetCorrectExtension2_messageSetExtension: Bool {
    return hasExtensionValue(ext: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension2.Extensions.message_set_extension)
  }
...
extension ProtobufTestMessages_Edition_TestAllTypesEdition {
  ...
  var ProtobufTestMessages_Edition_extensionInt32: Int32 {
    get {return getExtensionValue(ext: ProtobufTestMessages_Edition_Extensions_extension_int32) ?? 0}
    set {setExtensionValue(ext: ProtobufTestMessages_Edition_Extensions_extension_int32, value: newValue)}
  }
  /// Returns true if extension `ProtobufTestMessages_Edition_Extensions_extension_int32`
  /// has been explicitly set.
  var hasProtobufTestMessages_Edition_extensionInt32: Bool {
    return hasExtensionValue(ext: ProtobufTestMessages_Edition_Extensions_extension_int32)
  }
  /// Clears the value of extension `ProtobufTestMessages_Edition_Extensions_extension_int32`.
  /// Subsequent reads from it will return its default value.
  mutating func clearProtobufTestMessages_Edition_extensionInt32() {
...
extension ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrect {
  ...
  var ProtobufTestMessages_Edition_TestAllTypesEdition_MessageSetCorrectExtension1_messageSetExtension: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension1 {
    get {return getExtensionValue(ext: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension1.Extensions.message_set_extension) ?? ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension1()}
    set {setExtensionValue(ext: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension1.Extensions.message_set_extension, value: newValue)}
  }
  ...
  /// has been explicitly set.
  var hasProtobufTestMessages_Edition_TestAllTypesEdition_MessageSetCorrectExtension1_messageSetExtension: Bool {
    return hasExtensionValue(ext: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension1.Extensions.message_set_extension)
  }
  ...
  mutating func clearProtobufTestMessages_Edition_TestAllTypesEdition_MessageSetCorrectExtension1_messageSetExtension() {
    clearExtensionValue(ext: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension1.Extensions.message_set_extension)
  }
  ...
  var ProtobufTestMessages_Edition_TestAllTypesEdition_MessageSetCorrectExtension2_messageSetExtension: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension2 {
    get {return getExtensionValue(ext: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension2.Extensions.message_set_extension) ?? ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension2()}
    set {setExtensionValue(ext: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension2.Extensions.message_set_extension, value: newValue)}
  }
  ...
  /// has been explicitly set.
  var hasProtobufTestMessages_Edition_TestAllTypesEdition_MessageSetCorrectExtension2_messageSetExtension: Bool {
    return hasExtensionValue(ext: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension2.Extensions.message_set_extension)
  }
  ...
  mutating func clearProtobufTestMessages_Edition_TestAllTypesEdition_MessageSetCorrectExtension2_messageSetExtension() {
    clearExtensionValue(ext: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension2.Extensions.message_set_extension)
  }
...
let ProtobufTestMessages_Edition_SampleMessagesEdition_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let ProtobufTestMessages_Edition_Extensions_extension_int32 = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufInt32>, ProtobufTestMessages_Edition_TestAllTypesEdition>(
  _protobuf_fieldNumber: 120,
  fieldName: "protobuf_test_messages.edition.extension_int32"
)

extension ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension1 {
  enum Extensions {
    static let message_set_extension = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension1>, ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrect>(
      _protobuf_fieldNumber: 1547769,
      fieldName: "protobuf_test_messages.edition.TestAllTypesEdition.MessageSetCorrectExtension1"
    )
  }
}
...
extension ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension2 {
  enum Extensions {
    static let message_set_extension = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension2>, ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrect>(
      _protobuf_fieldNumber: 4135312,
      fieldName: "protobuf_test_messages.edition.TestAllTypesEdition.MessageSetCorrectExtension2"
    )
  }
}
...
extension ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension1 {
  enum Extensions {
    static let message_set_extension = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension1>, ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrect>(
      _protobuf_fieldNumber: 1547769,
      fieldName: "protobuf_test_messages.edition.TestAllRequiredTypesEdition.MessageSetCorrectExtension1"
    )
  }
}
...
extension ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension2 {
  enum Extensions {
    static let message_set_extension = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension2>, ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrect>(
      _protobuf_fieldNumber: 4135312,
      fieldName: "protobuf_test_messages.edition.TestAllRequiredTypesEdition.MessageSetCorrectExtension2"
    )
  }
}
...
extension ProtobufTestMessages_Edition_ForeignEnumEdition: SwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Edition_TestAllTypesEdition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _optionalNestedMessage: ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage? = nil
    var _optionalForeignMessage: ProtobufTestMessages_Edition_ForeignMessageEdition? = nil
    var _optionalNestedEnum: ProtobufTestMessages_Edition_TestAllTypesEdition.NestedEnum? = nil
    var _optionalForeignEnum: ProtobufTestMessages_Edition_ForeignEnumEdition? = nil
    var _optionalStringPiece: String? = nil
    var _optionalCord: String? = nil
    var _recursiveMessage: ProtobufTestMessages_Edition_TestAllTypesEdition? = nil
    ...
    var _repeatedNestedMessage: [ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage] = []
    var _repeatedForeignMessage: [ProtobufTestMessages_Edition_ForeignMessageEdition] = []
    var _repeatedNestedEnum: [ProtobufTestMessages_Edition_TestAllTypesEdition.NestedEnum] = []
    var _repeatedForeignEnum: [ProtobufTestMessages_Edition_ForeignEnumEdition] = []
    ...
    var _packedNestedEnum: [ProtobufTestMessages_Edition_TestAllTypesEdition.NestedEnum] = []
    ...
    var _unpackedNestedEnum: [ProtobufTestMessages_Edition_TestAllTypesEdition.NestedEnum] = []
    ...
    var _mapStringNestedMessage: Dictionary<String,ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage> = [:]
    var _mapStringForeignMessage: Dictionary<String,ProtobufTestMessages_Edition_ForeignMessageEdition> = [:]
    var _mapStringNestedEnum: Dictionary<String,ProtobufTestMessages_Edition_TestAllTypesEdition.NestedEnum> = [:]
    var _mapStringForeignEnum: Dictionary<String,ProtobufTestMessages_Edition_ForeignEnumEdition> = [:]
    var _oneofField: ProtobufTestMessages_Edition_TestAllTypesEdition.OneOf_OneofField?
    var _data: ProtobufTestMessages_Edition_TestAllTypesEdition.DataMessage? = nil
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 71: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage>.self, value: &_storage._mapStringNestedMessage) }()
        case 72: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Edition_ForeignMessageEdition>.self, value: &_storage._mapStringForeignMessage) }()
        case 73: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Edition_TestAllTypesEdition.NestedEnum>.self, value: &_storage._mapStringNestedEnum) }()
        case 74: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Edition_ForeignEnumEdition>.self, value: &_storage._mapStringForeignEnum) }()
        ...
        case 112: try {
          var v: ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage?
        ...
        case 119: try {
          var v: ProtobufTestMessages_Edition_TestAllTypesEdition.NestedEnum?
        ...
        case 120..<201:
          try { try decoder.decodeExtensionField(values: &_protobuf_extensionFieldValues, messageType: ProtobufTestMessages_Edition_TestAllTypesEdition.self, fieldNumber: fieldNumber) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._mapStringNestedMessage.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage>.self, value: _storage._mapStringNestedMessage, fieldNumber: 71)
      }
      if !_storage._mapStringForeignMessage.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Edition_ForeignMessageEdition>.self, value: _storage._mapStringForeignMessage, fieldNumber: 72)
      }
      if !_storage._mapStringNestedEnum.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Edition_TestAllTypesEdition.NestedEnum>.self, value: _storage._mapStringNestedEnum, fieldNumber: 73)
      }
      if !_storage._mapStringForeignEnum.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Edition_ForeignEnumEdition>.self, value: _storage._mapStringForeignEnum, fieldNumber: 74)
      }
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllTypesEdition, rhs: ProtobufTestMessages_Edition_TestAllTypesEdition) -> Bool {
...
extension ProtobufTestMessages_Edition_TestAllTypesEdition.NestedEnum: SwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage, rhs: ProtobufTestMessages_Edition_TestAllTypesEdition.NestedMessage) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension ProtobufTestMessages_Edition_TestAllTypesEdition.DataMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Edition_TestAllTypesEdition.protoMessageName + ".Data"
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllTypesEdition.DataMessage, rhs: ProtobufTestMessages_Edition_TestAllTypesEdition.DataMessage) -> Bool {
...
extension ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrect: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Edition_TestAllTypesEdition.protoMessageName + ".MessageSetCorrect"
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    try decoder.decodeExtensionFieldsAsMessageSet(values: &_protobuf_extensionFieldValues, messageType: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrect.self)
  }
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrect, rhs: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrect) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    if lhs._protobuf_extensionFieldValues != rhs._protobuf_extensionFieldValues {return false}
    return true
  }
...
extension ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension1: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Edition_TestAllTypesEdition.protoMessageName + ".MessageSetCorrectExtension1"
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension1, rhs: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension1) -> Bool {
...
extension ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Edition_TestAllTypesEdition.protoMessageName + ".MessageSetCorrectExtension2"
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension2, rhs: ProtobufTestMessages_Edition_TestAllTypesEdition.MessageSetCorrectExtension2) -> Bool {
...
extension ProtobufTestMessages_Edition_ForeignMessageEdition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ForeignMessageEdition"
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_ForeignMessageEdition, rhs: ProtobufTestMessages_Edition_ForeignMessageEdition) -> Bool {
...
extension ProtobufTestMessages_Edition_UnknownToTestAllTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.repeatedInt32.isEmpty {
      try visitor.visitPackedInt32Field(value: self.repeatedInt32, fieldNumber: 1011)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: ProtobufTestMessages_Edition_UnknownToTestAllTypes, rhs: ProtobufTestMessages_Edition_UnknownToTestAllTypes) -> Bool {
...
extension ProtobufTestMessages_Edition_UnknownToTestAllTypes.OptionalGroup: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Edition_UnknownToTestAllTypes.protoMessageName + ".OptionalGroup"
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_UnknownToTestAllTypes.OptionalGroup, rhs: ProtobufTestMessages_Edition_UnknownToTestAllTypes.OptionalGroup) -> Bool {
...
extension ProtobufTestMessages_Edition_NullHypothesisEdition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".NullHypothesisEdition"
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_NullHypothesisEdition, rhs: ProtobufTestMessages_Edition_NullHypothesisEdition) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension ProtobufTestMessages_Edition_EnumOnlyEdition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EnumOnlyEdition"
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_EnumOnlyEdition, rhs: ProtobufTestMessages_Edition_EnumOnlyEdition) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension ProtobufTestMessages_Edition_EnumOnlyEdition.BoolEnum: SwiftProtobuf._ProtoNameProviding {
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{0}kFalse\u{0}\u{1}\u{1}kTrue\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
}

extension ProtobufTestMessages_Edition_OneStringEdition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_OneStringEdition, rhs: ProtobufTestMessages_Edition_OneStringEdition) -> Bool {
...
extension ProtobufTestMessages_Edition_ProtoWithKeywords: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_ProtoWithKeywords, rhs: ProtobufTestMessages_Edition_ProtoWithKeywords) -> Bool {
...
extension ProtobufTestMessages_Edition_TestAllRequiredTypesEdition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".TestAllRequiredTypesEdition"
  ...
  fileprivate class _StorageClass {
    ...
    var _requiredNestedMessage: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.NestedMessage? = nil
    var _requiredForeignMessage: ProtobufTestMessages_Edition_ForeignMessageEdition? = nil
    var _requiredNestedEnum: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.NestedEnum? = nil
    var _requiredForeignEnum: ProtobufTestMessages_Edition_ForeignEnumEdition? = nil
    var _requiredStringPiece: String? = nil
    var _requiredCord: String? = nil
    var _recursiveMessage: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition? = nil
    var _optionalRecursiveMessage: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition? = nil
    var _data: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.DataMessage? = nil
    var _defaultInt32: Int32? = nil
    var _defaultInt64: Int64? = nil
    var _defaultUint32: UInt32? = nil
    var _defaultUint64: UInt64? = nil
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 255: try { try decoder.decodeSingularBytesField(value: &_storage._defaultBytes) }()
        case 120..<201:
          try { try decoder.decodeExtensionField(values: &_protobuf_extensionFieldValues, messageType: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.self, fieldNumber: fieldNumber) }()
        default: break
        }
      }
    }
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition, rhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.NestedEnum: SwiftProtobuf._ProtoNameProviding {
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{7f}\u{7f}\u{7f}\u{7f}\u{7f}\u{3}NEG\u{0}\u{1}\u{0}FOO\u{0}\u{1}\u{1}BAR\u{0}\u{1}\u{2}BAZ\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
}

extension ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.NestedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.NestedMessage, rhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.NestedMessage) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.DataMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.protoMessageName + ".Data"
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{2}J\u{3}group_int32\u{0}\u{2}K\u{3}group_uint32\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.DataMessage, rhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.DataMessage) -> Bool {
    if lhs._groupInt32 != rhs._groupInt32 {return false}
    if lhs._groupUint32 != rhs._groupUint32 {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrect: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.protoMessageName + ".MessageSetCorrect"
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    try decoder.decodeExtensionFieldsAsMessageSet(values: &_protobuf_extensionFieldValues, messageType: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrect.self)
  }
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrect, rhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrect) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    if lhs._protobuf_extensionFieldValues != rhs._protobuf_extensionFieldValues {return false}
    return true
  }
...
extension ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension1: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.protoMessageName + ".MessageSetCorrectExtension1"
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{19}str\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension1, rhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension1) -> Bool {
    if lhs._str != rhs._str {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.protoMessageName + ".MessageSetCorrectExtension2"
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{9}i\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
  ...
  static func ==(lhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension2, rhs: ProtobufTestMessages_Edition_TestAllRequiredTypesEdition.MessageSetCorrectExtension2) -> Bool {
    if lhs._i != rhs._i {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
