...
nonisolated struct LegacyFeaturesUnittest_TestEditionsMessage: @unchecked Sendable {
...
fileprivate nonisolated let _protobuf_package = "legacy_features_unittest"

nonisolated extension LegacyFeaturesUnittest_TestEditionsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".TestEditionsMessage"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}required_field\0\u{3}delimited_field\0")
