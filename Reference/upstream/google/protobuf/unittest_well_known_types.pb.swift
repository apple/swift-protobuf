...
nonisolated struct Proto2Unittest_TestWellKnownTypes: @unchecked Swift.Sendable {
...
nonisolated struct Proto2Unittest_RepeatedWellKnownTypes: @unchecked Swift.Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Proto2Unittest_OneofWellKnownTypes: @unchecked Swift.Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Proto2Unittest_MapWellKnownTypes: @unchecked Swift.Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension Proto2Unittest_TestWellKnownTypes: SwiftProtobuf.GeneratedMessage {
...
nonisolated extension Proto2Unittest_RepeatedWellKnownTypes: SwiftProtobuf.GeneratedMessage {
...
nonisolated extension Proto2Unittest_OneofWellKnownTypes: SwiftProtobuf.GeneratedMessage {
...
nonisolated extension Proto2Unittest_MapWellKnownTypes: SwiftProtobuf.GeneratedMessage {
