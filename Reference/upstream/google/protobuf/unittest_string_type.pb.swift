...
struct Proto2Unittest_EntryProto: @unchecked Sendable {
...
extension Proto2Unittest_EntryProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EntryProto"
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{3}value\u{0}"
  ...
  static func ==(lhs: Proto2Unittest_EntryProto, rhs: Proto2Unittest_EntryProto) -> Bool {
