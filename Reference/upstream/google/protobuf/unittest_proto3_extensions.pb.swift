...
struct ProtobufUnittest_Proto3FileExtensions {
...
extension ProtobufUnittest_Proto3FileExtensions: @unchecked Sendable {}
...
extension SwiftProtobuf.Google_Protobuf_FileOptions {
  ...
  /// Returns true if extension `ProtobufUnittest_Proto3FileExtensions.Extensions.repeated_int`
  /// has been explicitly set.
  var hasProtobufUnittest_Proto3FileExtensions_repeatedInt: Bool {
    return hasExtensionValue(ext: ProtobufUnittest_Proto3FileExtensions.Extensions.repeated_int)
  }
  /// Clears the value of extension `ProtobufUnittest_Proto3FileExtensions.Extensions.repeated_int`.
  /// Subsequent reads from it will return its default value.
  mutating func clearProtobufUnittest_Proto3FileExtensions_repeatedInt() {
    clearExtensionValue(ext: ProtobufUnittest_Proto3FileExtensions.Extensions.repeated_int)
  }
