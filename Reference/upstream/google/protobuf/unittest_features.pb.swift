...
nonisolated struct Pb_CustomOptionLifetimesMessage: @unchecked Swift.Sendable {
...
nonisolated struct Pb_TestMessage: @unchecked Swift.Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Pb_TestMessageFeatures: @unchecked Swift.Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Pb_TestNestedFeatures: @unchecked Swift.Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Pb_TestFeatures: @unchecked Swift.Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated let Pb_UnittestFeatures_Extensions: SwiftProtobuf.ExtensionMap = [
...
nonisolated let Pb_Extensions_custom_option_lifetimes_message = SwiftProtobuf.ExtensionSchema(
...
nonisolated let Pb_Extensions_test = SwiftProtobuf.ExtensionSchema(
...
nonisolated extension Pb_CustomOptionLifetimesEnum {
...
nonisolated extension Pb_EnumFeature {
...
nonisolated extension Pb_UnstableEnumFeature {
...
nonisolated extension Pb_ValueLifetimeFeature {
...
nonisolated extension Pb_CustomOptionLifetimesMessage: SwiftProtobuf.GeneratedMessage {
...
nonisolated extension Pb_TestMessage: SwiftProtobuf.GeneratedMessage {
...
nonisolated extension Pb_TestMessage.Nested: SwiftProtobuf.GeneratedMessage {
...
nonisolated extension Pb_TestMessageFeatures: SwiftProtobuf.GeneratedMessage {
...
nonisolated extension Pb_TestNestedFeatures: SwiftProtobuf.GeneratedMessage {
...
nonisolated extension Pb_TestFeatures: SwiftProtobuf.GeneratedMessage {
