...
extension EditionsUnittest_TestDelimited: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{1}lengthprefixed\u{0}\u{1}\u{2}nested\u{0}\u{1}\u{3}grouplike\u{0}\u{3}\u{3}GroupLike\u{0}grouplike\u{0}\u{1}\u{4}notgrouplike\u{0}\u{1}\u{5}notgrouplikescope\u{0}\u{1}\u{6}messageimport\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
