...
extension ProtobufUnittest_GID: CaseIterable {
...
extension ProtobufUnittest_UID: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension ProtobufUnittest_BadNames: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension ProtobufUnittest_GID: @unchecked Sendable {}
extension ProtobufUnittest_UID: @unchecked Sendable {}
extension ProtobufUnittest_BadNames: @unchecked Sendable {}
