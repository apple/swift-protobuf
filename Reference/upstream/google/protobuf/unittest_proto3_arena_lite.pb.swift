...
/// forms.
nonisolated struct Proto3ArenaLiteUnittest_TestAllTypes: @unchecked Sendable {
  ...
  var optionalNestedMessage: Proto3ArenaLiteUnittest_TestAllTypes.NestedMessage {
    get {_storage._optionalNestedMessage ?? Proto3ArenaLiteUnittest_TestAllTypes.NestedMessage()}
  ...
  var optionalLazyMessage: Proto3ArenaLiteUnittest_TestAllTypes.NestedMessage {
    get {_storage._optionalLazyMessage ?? Proto3ArenaLiteUnittest_TestAllTypes.NestedMessage()}
...
nonisolated struct Proto3ArenaLiteUnittest_TestUnpackedTypes: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Proto3ArenaLiteUnittest_NestedTestAllTypes: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var payload: Proto3ArenaLiteUnittest_TestAllTypes {
    get {_storage._payload ?? Proto3ArenaLiteUnittest_TestAllTypes()}
...
/// that.
nonisolated struct Proto3ArenaLiteUnittest_ForeignMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Proto3ArenaLiteUnittest_TestEmptyMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate nonisolated let _protobuf_package = "proto3_arena_lite_unittest"

nonisolated extension Proto3ArenaLiteUnittest_ForeignEnum: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Proto3ArenaLiteUnittest_TestAllTypes.NestedEnum: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Proto3ArenaLiteUnittest_TestAllTypes.NestedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Proto3ArenaLiteUnittest_TestPackedTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Proto3ArenaLiteUnittest_TestUnpackedTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Proto3ArenaLiteUnittest_NestedTestAllTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Proto3ArenaLiteUnittest_ForeignMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Proto3ArenaLiteUnittest_TestEmptyMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
