...
extension Proto2Unittest_TestAny: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{2}\u{1}int32_value\u{0}\u{2}\u{2}any_value\u{0}\u{2}\u{3}repeated_any_value\u{0}\u{1}\u{4}text\u{0}"
