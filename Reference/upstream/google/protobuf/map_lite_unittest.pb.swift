...
extension Proto2Unittest_Proto2MapEnumLite: SwiftProtobuf._ProtoNameProviding {
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{0}PROTO2_MAP_ENUM_FOO_LITE\u{0}\u{1}\u{1}PROTO2_MAP_ENUM_BAR_LITE\u{0}\u{1}\u{2}PROTO2_MAP_ENUM_BAZ_LITE\u{0}"
...
extension Proto2Unittest_Proto2MapEnumPlusExtraLite: SwiftProtobuf._ProtoNameProviding {
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{0}E_PROTO2_MAP_ENUM_FOO_LITE\u{0}\u{1}\u{1}E_PROTO2_MAP_ENUM_BAR_LITE\u{0}\u{1}\u{2}E_PROTO2_MAP_ENUM_BAZ_LITE\u{0}\u{1}\u{3}E_PROTO2_MAP_ENUM_EXTRA_LITE\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
}

extension Proto2Unittest_MapEnumLite: SwiftProtobuf._ProtoNameProviding {
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{0}MAP_ENUM_FOO_LITE\u{0}\u{1}\u{1}MAP_ENUM_BAR_LITE\u{0}\u{1}\u{2}MAP_ENUM_BAZ_LITE\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
}
...
extension Proto2Unittest_TestMapLite: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{2}\u{1}map_int32_int32\u{0}\u{2}\u{2}map_int64_int64\u{0}\u{2}\u{3}map_uint32_uint32\u{0}\u{2}\u{4}map_uint64_uint64\u{0}\u{2}\u{5}map_sint32_sint32\u{0}\u{2}\u{6}map_sint64_sint64\u{0}\u{2}\u{7}map_fixed32_fixed32\u{0}\u{2}\u{8}map_fixed64_fixed64\u{0}\u{2}\u{9}map_sfixed32_sfixed32\u{0}\u{2}\u{a}map_sfixed64_sfixed64\u{0}\u{2}\u{b}map_int32_float\u{0}\u{2}\u{c}map_int32_double\u{0}\u{2}\u{d}map_bool_bool\u{0}\u{2}\u{e}map_string_string\u{0}\u{2}\u{f}map_int32_bytes\u{0}\u{2}\u{10}map_int32_enum\u{0}\u{2}\u{11}map_int32_foreign_message\u{0}\u{1}\u{12}teboring\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
...
extension Proto2Unittest_TestEnumMapLite: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{2}e\u{1}known_map_field\u{0}\u{2}f\u{1}unknown_map_field\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
...
extension Proto2Unittest_TestRequiredLite: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{1}a\u{0}\u{1}\u{2}b\u{0}\u{1}\u{3}c\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
