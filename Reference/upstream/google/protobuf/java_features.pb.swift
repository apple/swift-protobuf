...
nonisolated struct Pb_JavaFeatures: Sendable {
  ...
  nonisolated enum Utf8Validation: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
nonisolated let Pb_JavaFeatures_Extensions: SwiftProtobuf.SimpleExtensionMap = [
  Pb_Extensions_java
]
...
nonisolated let Pb_Extensions_java = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Pb_JavaFeatures>, SwiftProtobuf.Google_Protobuf_FeatureSet>(
...
nonisolated extension Pb_JavaFeatures: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Pb_JavaFeatures.Utf8Validation: SwiftProtobuf._ProtoNameProviding {
