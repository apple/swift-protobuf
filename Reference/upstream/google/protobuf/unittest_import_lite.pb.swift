...
extension Proto2UnittestImport_ImportEnumLite: SwiftProtobuf._ProtoNameProviding {
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{7}IMPORT_LITE_FOO\u{0}\u{1}\u{8}IMPORT_LITE_BAR\u{0}\u{1}\u{9}IMPORT_LITE_BAZ\u{0}"
