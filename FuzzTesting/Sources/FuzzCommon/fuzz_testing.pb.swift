...
public struct Fuzz_Testing_Message: SwiftProtobuf.ExtensibleMessage {
  ...
  public var singularBytes: [UInt8] {
  ...
  public var mapInt64Bytes: Dictionary<Int64,[UInt8]> {
  ...
  public var mapUint32Bytes: Dictionary<UInt32,[UInt8]> {
  ...
  public var mapUint64Bytes: Dictionary<UInt64,[UInt8]> {
  ...
  public var mapSint32Bytes: Dictionary<Int32,[UInt8]> {
  ...
  public var mapSint64Bytes: Dictionary<Int64,[UInt8]> {
  ...
  public var mapFixed32Bytes: Dictionary<UInt32,[UInt8]> {
  ...
  public var mapFixed64Bytes: Dictionary<UInt64,[UInt8]> {
  ...
  public var mapSfixed32Bytes: Dictionary<Int32,[UInt8]> {
  ...
  public var mapSfixed64Bytes: Dictionary<Int64,[UInt8]> {
  ...
  public var mapBoolBytes: Dictionary<Bool,[UInt8]> {
...
extension Fuzz_Testing_Message {
  ...
  public var Fuzz_Testing_singularBytesExt: [UInt8] {
  ...
  public var Fuzz_Testing_repeatedBytesExt: [[UInt8]] {
