...
class EnumGenerator {
  ...
  func generateRuntimeSupport(printer p: inout CodePrinter, textPrinter textP: inout CodePrinter) {
    textP.print("\n")
    textP.print("extension \(swiftFullName): \(namer.swiftProtobufModuleName)._ProtoNameProviding {\n")
    textP.indent()
