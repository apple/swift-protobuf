...
class FileGenerator {
    ...
    private func outputFilename(_ ext: String) -> String {
    ...
    var outputFilename: String { return outputFilename(".pb.swift") }
    var outputTextFilename: String { return outputFilename(".pb.text.swift") }
    ...
    func generateOutputFile(printer p: inout CodePrinter, textPrinter textP: inout CodePrinter, errorString: inout String?) {
        ...
        if !fileDescriptor.isBundledProto {
            ...
            textP.print("import \(namer.swiftProtobufModuleName)\n")
        }
        ...
        generateVersionCheck(printer: &textP)
        ...
        if needsProtoPackage || !enums.isEmpty || !messages.isEmpty {
            ...
            for m in messages {
                m.generateRuntimeSupport(printer: &p, textPrinter: &textP, file: self, parent: nil)
            }
        }
    }
