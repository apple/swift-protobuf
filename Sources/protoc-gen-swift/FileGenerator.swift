...
class FileGenerator {
    ...
    func generateOutputFile(printer p: inout CodePrinter, context: Context) {
        ...
        var protocInfo = "unknown protoc version"
        if (context.request.hasCompilerVersion) {
            let compilerVersion = context.request.compilerVersion;
            protocInfo = "protoc \(compilerVersion.versionString)"
        }
        p.print(
            "/*\n",
            " * DO NOT EDIT.\n",
            " *\n",
            " * Generated by \(protocInfo) and \(Version.versionedName).\n",
