      ...
      public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
            if !self.mapping.isEmpty {
                  try visitor.visitRepeatedMessageField(
                        value: self.mapping, fieldNumber: 1)
            }
            try unknownFields.traverse(visitor: &visitor)
      }

      public static func == (
            lhs: SwiftProtobuf_GenSwift_ModuleMappings,
      ...
      SwiftProtobuf._ProtoNameProviding
{
      public static let protoMessageName: String
            = SwiftProtobuf_GenSwift_ModuleMappings.protoMessageName + ".Entry"
      public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
      ...
      public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
            if !self.moduleName.isEmpty {
                  try visitor.visitSingularStringField(
                        value: self.moduleName, fieldNumber: 1)
            }
            if !self.protoFilePath.isEmpty {
                  try visitor.visitRepeatedStringField(
                        value: self.protoFilePath, fieldNumber: 2)
            }
            try unknownFields.traverse(visitor: &visitor)
      }

      public static func == (
            lhs: SwiftProtobuf_GenSwift_ModuleMappings.Entry,
            rhs: SwiftProtobuf_GenSwift_ModuleMappings.Entry
      ) -> Bool {
