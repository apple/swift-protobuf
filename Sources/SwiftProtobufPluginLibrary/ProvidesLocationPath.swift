...
public protocol ProvidesLocationPath {
    /// Updates path to the source location of the complete extent of the
    /// object conforming to this protocol.
    ///
    /// This is a replacement for `GetSourceLocation()` in the C++ Descriptor
    /// apis.
