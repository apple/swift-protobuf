...
public nonisolated struct Google_Protobuf_Compiler_Version: @unchecked Swift.Sendable {
  ...
  public mutating func clearSuffix() { _uniqueStorage().clearValue(atIndex: 0, type: String.self, hasBit: (0, 8)) }
...
public nonisolated struct Google_Protobuf_Compiler_CodeGeneratorRequest: @unchecked Swift.Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public mutating func clearParameter() { _uniqueStorage().clearValue(atIndex: 0, type: String.self, hasBit: (0, 1)) }
  ...
  public mutating func clearCompilerVersion() { _uniqueStorage().clearValue(atIndex: 0, type: Google_Protobuf_Compiler_Version.self, hasBit: (0, 2)) }
...
public nonisolated struct Google_Protobuf_Compiler_CodeGeneratorResponse: @unchecked Swift.Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public mutating func clearError() { _uniqueStorage().clearValue(atIndex: 0, type: String.self, hasBit: (0, 1)) }
  ...
  public nonisolated enum Feature: Swift.Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case none = 0
  ...
  public nonisolated struct File: @unchecked Swift.Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public mutating func clearInsertionPoint() { _uniqueStorage().clearValue(atIndex: 1, type: String.self, hasBit: (0, 2)) }
    ...
    public mutating func clearContent() { _uniqueStorage().clearValue(atIndex: 2, type: String.self, hasBit: (0, 4)) }
    ...
    public mutating func clearGeneratedCodeInfo() { _uniqueStorage().clearValue(atIndex: 0, type: SwiftProtobuf.Google_Protobuf_GeneratedCodeInfo.self, hasBit: (0, 8)) }
...
nonisolated extension Google_Protobuf_Compiler_CodeGeneratorRequest: SwiftProtobuf.GeneratedMessage {
  ...
  private static func _protobuf_resolveSubmessageOrEnum(for token: SwiftProtobuf.SubmessageOrEnumToken) -> SwiftProtobuf.SubmessageOrEnumSchema {
    switch token.index {
    case 1: return .message(SwiftProtobuf.Google_Protobuf_FileDescriptorProto.messageSchema)
    case 2: return .message(Google_Protobuf_Compiler_Version.messageSchema)
