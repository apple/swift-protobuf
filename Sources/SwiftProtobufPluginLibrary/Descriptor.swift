...
public final class DescriptorSet {
      ...
      public init(protos: [Google_Protobuf_FileDescriptorProto]) {
            ...
            self.files = protos.map {
                  return FileDescriptor(proto: $0, registry: registry)
            }
      }
      ...
      public func lookupServiceDescriptor(protoName name: String)
            -> ServiceDescriptor
...
public final class FileDescriptor {
      ...
      fileprivate init(
            proto: Google_Protobuf_FileDescriptorProto, registry: Registry
      ) {
            self.proto = proto
            ...
            if protoPackage.isEmpty { prefix = "" }
            else { prefix = "." + protoPackage }

            self.enums = proto.enumType.enumeratedMap {
                  return EnumDescriptor(
                        proto: $1, index: $0, registry: registry,
            ...
            // to have to be weak.
            self.dependencies = proto.dependency.map {
                  return registry.fileDescriptor(name: $0)
            }
            ...
            self.enums.forEach {
                  $0.bind(file: self, registry: registry, containingType: nil)
            }
            self.messages.forEach {
                  $0.bind(file: self, registry: registry, containingType: nil)
            }
            self.extensions.forEach {
                  $0.bind(file: self, registry: registry, containingType: nil)
            }
            self.services.forEach { $0.bind(file: self, registry: registry) }
      }

      public func sourceCodeInfoLocation(path: IndexPath)
            -> Google_Protobuf_SourceCodeInfo.Location?
      {
            guard let location = locationMap[path] else { return nil }
            return location
      }

      // Lazy so this can be computed on demand, as the imported files won't need
      // comments during generation.
      private lazy var locationMap: [IndexPath:
            Google_Protobuf_SourceCodeInfo.Location] = {
...
public final class Descriptor {
      ...
      public var extensionRanges:
            [Google_Protobuf_DescriptorProto.ExtensionRange]
      { return proto.extensionRange }

      public var useMessageSetWireFormat: Bool {
            return proto.options.messageSetWireFormat
      }

      fileprivate init(
            proto: Google_Protobuf_DescriptorProto, index: Int,
            registry: Registry, fullNamePrefix prefix: String
      ) {
            self.proto = proto
            self.index = index
      ...
      fileprivate func bind(
            file: FileDescriptor, registry: Registry,
            containingType: Descriptor?
      ) {
            self.file = file
            self.containingType = containingType
            self.enums.forEach {
                  $0.bind(file: file, registry: registry, containingType: self)
            }
            self.messages.forEach {
                  $0.bind(file: file, registry: registry, containingType: self)
            }
            ...
            self.oneofs.forEach {
                  $0.bind(registry: registry, containingType: self)
            }
            self.extensions.forEach {
                  $0.bind(file: file, registry: registry, containingType: self)
            }
...
public final class EnumDescriptor {
      ...
      public private(set) lazy var values: [EnumValueDescriptor] = {
            ...
            for p in self.proto.value {
                  ...
                  let d = EnumValueDescriptor(
                        proto: p, index: i, enumType: self, aliasing: aliasing)
                  result.append(d)
                  i += 1

                  if let aliasing = aliasing { aliasing.aliases.append(d) }
                  else { firstValues[d.number] = d }
            }
            return result
      }()
      ...
      fileprivate init(
            proto: Google_Protobuf_EnumDescriptorProto, index: Int,
            registry: Registry, fullNamePrefix prefix: String
      ) {
            self.proto = proto
            self.index = index
...
public final class EnumValueDescriptor {
      ...
      fileprivate init(
            proto: Google_Protobuf_EnumValueDescriptorProto, index: Int,
            enumType: EnumDescriptor, aliasing: EnumValueDescriptor?
      ) {
            self.proto = proto
            self.index = index
...
public final class OneofDescriptor {
      ...
      public private(set) lazy var fields: [FieldDescriptor] = {
            ...
            return self.containingType.fields.filter {
                  $0.oneofIndex == myIndex
            }
      }()

      fileprivate init(
            proto: Google_Protobuf_OneofDescriptorProto, index: Int,
            registry: Registry
      ) {
            self.proto = proto
            self.index = index
...
public final class FieldDescriptor {
      ...
      public var fullName: String {
            ...
            else { prefix = containingType.fullName }
      ...
      public var explicitDefaultValue: String? {
            if !proto.hasDefaultValue { return nil }
      ...
      public var isMap: Bool {
            ...
            if label != .repeated || type != .message { return false }
      ...
      public var isPacked: Bool {
            ...
            if file.syntax == .proto2 {
                  ...
                  return !proto.hasOptions || !proto.options.hasPacked
      ...
      fileprivate init(
            proto: Google_Protobuf_FieldDescriptorProto, index: Int,
            registry: Registry, isExtension: Bool = false
      ) {
            self.proto = proto
            self.index = index
      ...
      fileprivate func bind(
            ...
            if isExtension {
                  ...
                  self.containingType = registry.descriptor(
                        name: proto.extendee)
            }
            else { self.containingType = containingType }

            switch type {
            case .group, .message:
                  messageType = registry.descriptor(name: proto.typeName)
            case .enum: enumType = registry.enumDescriptor(name: proto.typeName)
            default: break
            }
      }
}
...
public final class ServiceDescriptor {
      ...
      fileprivate init(
            proto: Google_Protobuf_ServiceDescriptorProto, index: Int,
            registry: Registry, fullNamePrefix prefix: String
      ) {
            self.proto = proto
            self.index = index
...
public final class MethodDescriptor {
      ...
      fileprivate init(
            proto: Google_Protobuf_MethodDescriptorProto, index: Int,
            registry: Registry
      ) {
            self.proto = proto
            self.index = index
...
fileprivate final class Registry {
      ...
      func register(file: FileDescriptor) { fileMap[file.name] = file }
      func register(message: Descriptor) {
            messageMap[message.fullName] = message
      }
      func register(enum e: EnumDescriptor) { enumMap[e.fullName] = e }
      ...
      func descriptor(name: String) -> Descriptor { return messageMap[name]! }
