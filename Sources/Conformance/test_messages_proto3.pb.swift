...
extension ProtobufTestMessages_Proto3_TestAllTypesProto3: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _fields: [Field<Self>] = [
    ...
    .singularEnum({ $0.optionalNestedEnum }, fieldNumber: 21, defaultValue: .foo),
    .singularEnum({ $0.optionalForeignEnum }, fieldNumber: 22, defaultValue: .foreignFoo),
    .singularEnum({ $0.optionalAliasedEnum }, fieldNumber: 23, defaultValue: .aliasFoo),
    ...
    .map(type: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_TestAllTypesProto3.NestedMessage>.self, { $0.mapStringNestedMessage }, fieldNumber: 71),
    .map(type: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_ForeignMessage>.self, { $0.mapStringForeignMessage }, fieldNumber: 72),
    .map(type: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_TestAllTypesProto3.NestedEnum>.self, { $0.mapStringNestedEnum }, fieldNumber: 73),
    .map(type: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_ForeignEnum>.self, { $0.mapStringForeignEnum }, fieldNumber: 74),
    ...
    .oneOf({ $0.oneofField }) {
      ...
      case .oneofNullValue:
        return _oneOfField_oneofNullValue
      }
    },
    .singularMessage({ $0.optionalBoolWrapper }, fieldNumber: 201, isUnset: { $0._storage._optionalBoolWrapper == nil }),
    .singularMessage({ $0.optionalInt32Wrapper }, fieldNumber: 202, isUnset: { $0._storage._optionalInt32Wrapper == nil }),
    .singularMessage({ $0.optionalInt64Wrapper }, fieldNumber: 203, isUnset: { $0._storage._optionalInt64Wrapper == nil }),
    .singularMessage({ $0.optionalUint32Wrapper }, fieldNumber: 204, isUnset: { $0._storage._optionalUint32Wrapper == nil }),
    .singularMessage({ $0.optionalUint64Wrapper }, fieldNumber: 205, isUnset: { $0._storage._optionalUint64Wrapper == nil }),
    .singularMessage({ $0.optionalFloatWrapper }, fieldNumber: 206, isUnset: { $0._storage._optionalFloatWrapper == nil }),
    .singularMessage({ $0.optionalDoubleWrapper }, fieldNumber: 207, isUnset: { $0._storage._optionalDoubleWrapper == nil }),
    .singularMessage({ $0.optionalStringWrapper }, fieldNumber: 208, isUnset: { $0._storage._optionalStringWrapper == nil }),
    .singularMessage({ $0.optionalBytesWrapper }, fieldNumber: 209, isUnset: { $0._storage._optionalBytesWrapper == nil }),
    .repeatedMessage({ $0.repeatedBoolWrapper }, fieldNumber: 211),
    .repeatedMessage({ $0.repeatedInt32Wrapper }, fieldNumber: 212),
    .repeatedMessage({ $0.repeatedInt64Wrapper }, fieldNumber: 213),
    .repeatedMessage({ $0.repeatedUint32Wrapper }, fieldNumber: 214),
    .repeatedMessage({ $0.repeatedUint64Wrapper }, fieldNumber: 215),
    .repeatedMessage({ $0.repeatedFloatWrapper }, fieldNumber: 216),
    .repeatedMessage({ $0.repeatedDoubleWrapper }, fieldNumber: 217),
    .repeatedMessage({ $0.repeatedStringWrapper }, fieldNumber: 218),
    .repeatedMessage({ $0.repeatedBytesWrapper }, fieldNumber: 219),
    .singularMessage({ $0.optionalDuration }, fieldNumber: 301, isUnset: { $0._storage._optionalDuration == nil }),
    .singularMessage({ $0.optionalTimestamp }, fieldNumber: 302, isUnset: { $0._storage._optionalTimestamp == nil }),
    .singularMessage({ $0.optionalFieldMask }, fieldNumber: 303, isUnset: { $0._storage._optionalFieldMask == nil }),
    .singularMessage({ $0.optionalStruct }, fieldNumber: 304, isUnset: { $0._storage._optionalStruct == nil }),
    .singularMessage({ $0.optionalAny }, fieldNumber: 305, isUnset: { $0._storage._optionalAny == nil }),
    .singularMessage({ $0.optionalValue }, fieldNumber: 306, isUnset: { $0._storage._optionalValue == nil }),
    .singularEnum({ $0.optionalNullValue }, fieldNumber: 307, defaultValue: .nullValue),
    .repeatedMessage({ $0.repeatedDuration }, fieldNumber: 311),
    .repeatedMessage({ $0.repeatedTimestamp }, fieldNumber: 312),
    .repeatedMessage({ $0.repeatedFieldmask }, fieldNumber: 313),
    .repeatedMessage({ $0.repeatedAny }, fieldNumber: 315),
    .repeatedMessage({ $0.repeatedValue }, fieldNumber: 316),
    .repeatedMessage({ $0.repeatedListValue }, fieldNumber: 317),
    .repeatedMessage({ $0.repeatedStruct }, fieldNumber: 324),
    .singularInt32({ $0.fieldname1 }, fieldNumber: 401),
    .singularInt32({ $0.fieldName2 }, fieldNumber: 402),
    .singularInt32({ $0.fieldName3 }, fieldNumber: 403),
    .singularInt32({ $0.field_Name4_ }, fieldNumber: 404),
    .singularInt32({ $0.field0Name5 }, fieldNumber: 405),
    .singularInt32({ $0.field0Name6 }, fieldNumber: 406),
    .singularInt32({ $0.fieldName7 }, fieldNumber: 407),
    .singularInt32({ $0.fieldName8 }, fieldNumber: 408),
    .singularInt32({ $0.fieldName9 }, fieldNumber: 409),
    .singularInt32({ $0.fieldName10 }, fieldNumber: 410),
    .singularInt32({ $0.fieldName11 }, fieldNumber: 411),
    .singularInt32({ $0.fieldName12 }, fieldNumber: 412),
    .singularInt32({ $0._FieldName13 }, fieldNumber: 413),
    .singularInt32({ $0._FieldName14 }, fieldNumber: 414),
    .singularInt32({ $0.field_Name15 }, fieldNumber: 415),
    .singularInt32({ $0.field_Name16 }, fieldNumber: 416),
    .singularInt32({ $0.fieldName17__ }, fieldNumber: 417),
    .singularInt32({ $0.fieldName18__ }, fieldNumber: 418),
  ]
  ...
  private static let _oneOfField_oneofNullValue: Field<Self> = .singularEnum({ $0.oneofNullValue }, fieldNumber: 120, isUnset: { _ in false })
...
extension ProtobufTestMessages_Proto3_TestAllTypesProto3.NestedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _fields: [Field<Self>] = [
    .singularInt32({ $0.a }, fieldNumber: 1),
