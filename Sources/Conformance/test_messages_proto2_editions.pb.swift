...
nonisolated enum ProtobufTestMessages_Editions_Proto2_ForeignEnumProto2: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  case foreignFoo = 0
  case foreignBar = 1
  case foreignBaz = 2
...
nonisolated struct ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2: SwiftProtobuf.ExtensibleMessage, @unchecked Sendable {
  ...
  var optionalNestedMessage: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage {
    get {_storage._optionalNestedMessage ?? ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage()}
  ...
  var recursiveMessage: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2 {
    get {_storage._recursiveMessage ?? ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2()}
  ...
  var mapInt32NestedMessage: Dictionary<Int32,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage> {
    get {_storage._mapInt32NestedMessage}
  ...
  var mapStringNestedMessage: Dictionary<String,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage> {
    get {_storage._mapStringNestedMessage}
    set {_uniqueStorage()._mapStringNestedMessage = newValue}
  }

  var mapStringForeignMessage: Dictionary<String,ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2> {
    get {_storage._mapStringForeignMessage}
    set {_uniqueStorage()._mapStringForeignMessage = newValue}
  }

  var mapStringNestedEnum: Dictionary<String,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedEnum> {
    get {_storage._mapStringNestedEnum}
    set {_uniqueStorage()._mapStringNestedEnum = newValue}
  }

  var mapStringForeignEnum: Dictionary<String,ProtobufTestMessages_Editions_Proto2_ForeignEnumProto2> {
  ...
  var oneofNestedMessage: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage {
    get {
      ...
      return ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage()
    }
  ...
  var data: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.DataMessage {
    get {_storage._data ?? ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.DataMessage()}
  ...
  var multiWordGroupField: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MultiWordGroupField {
    get {_storage._multiWordGroupField ?? ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MultiWordGroupField()}
    set {_uniqueStorage()._multiWordGroupField = newValue}
  }
  /// Returns true if `multiWordGroupField` has been explicitly set.
  var hasMultiWordGroupField: Bool {_storage._multiWordGroupField != nil}
  ...
  var defaultInt32: Int32 {
    get {_storage._defaultInt32 ?? -123456789}
  ...
  var defaultInt64: Int64 {
    get {_storage._defaultInt64 ?? -9123456789123456789}
  ...
  var defaultUint32: UInt32 {
    get {_storage._defaultUint32 ?? 2123456789}
  ...
  var defaultUint64: UInt64 {
    get {_storage._defaultUint64 ?? 10123456789123456789}
  ...
  var defaultSint32: Int32 {
    get {_storage._defaultSint32 ?? -123456789}
  ...
  var defaultSint64: Int64 {
    get {_storage._defaultSint64 ?? -9123456789123456789}
  ...
  var defaultFixed32: UInt32 {
    get {_storage._defaultFixed32 ?? 2123456789}
  ...
  var defaultFixed64: UInt64 {
    get {_storage._defaultFixed64 ?? 10123456789123456789}
  ...
  var defaultSfixed32: Int32 {
    get {_storage._defaultSfixed32 ?? -123456789}
  ...
  var defaultSfixed64: Int64 {
    get {_storage._defaultSfixed64 ?? -9123456789123456789}
  ...
  var defaultFloat: Float {
    get {_storage._defaultFloat ?? 9e+09}
  ...
  var defaultDouble: Double {
    get {_storage._defaultDouble ?? 7e+22}
  ...
  var defaultString: String {
    get {_storage._defaultString ?? "Rosebud"}
  ...
  var defaultBytes: Data {
    get {_storage._defaultBytes ?? Data([106, 111, 115, 104, 117, 97])}
  ...
  var messageSetCorrect: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect {
    get {_storage._messageSetCorrect ?? ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect()}
    set {_uniqueStorage()._messageSetCorrect = newValue}
  }
  /// Returns true if `messageSetCorrect` has been explicitly set.
  var hasMessageSetCorrect: Bool {_storage._messageSetCorrect != nil}
  ...
  nonisolated struct MultiWordGroupField: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  nonisolated struct MessageSetCorrect: SwiftProtobuf.ExtensibleMessage, Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  nonisolated struct MessageSetCorrectExtension1: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  nonisolated struct MessageSetCorrectExtension2: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    var subMsg: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect {
      get {_subMsg ?? ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect()}
    ...
    fileprivate var _subMsg: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect? = nil
  }

  nonisolated struct ExtensionWithOneof: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    var oneofField: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof.OneOf_OneofField? = nil
...
nonisolated struct ProtobufTestMessages_Editions_Proto2_GroupField: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct ProtobufTestMessages_Editions_Proto2_UnknownToTestAllTypes: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var nestedMessage: ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2 {
    get {_nestedMessage ?? ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2()}
  ...
  var optionalGroup: ProtobufTestMessages_Editions_Proto2_UnknownToTestAllTypes.OptionalGroup {
    get {_optionalGroup ?? ProtobufTestMessages_Editions_Proto2_UnknownToTestAllTypes.OptionalGroup()}
  ...
  var optionalBool: Bool {
    get {_optionalBool ?? false}
    set {_optionalBool = newValue}
  }
  /// Returns true if `optionalBool` has been explicitly set.
  var hasOptionalBool: Bool {self._optionalBool != nil}
  /// Clears the value of `optionalBool`. Subsequent reads from it will return its default value.
  ...
  fileprivate var _nestedMessage: ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2? = nil
  fileprivate var _optionalGroup: ProtobufTestMessages_Editions_Proto2_UnknownToTestAllTypes.OptionalGroup? = nil
  fileprivate var _optionalBool: Bool? = nil
}

nonisolated struct ProtobufTestMessages_Editions_Proto2_NullHypothesisProto2: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct ProtobufTestMessages_Editions_Proto2_EnumOnlyProto2: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated enum BoolEnum: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case kFalse = 0
    case kTrue = 1
...
nonisolated struct ProtobufTestMessages_Editions_Proto2_OneStringProto2: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct ProtobufTestMessages_Editions_Proto2_ProtoWithKeywords: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasInline: Bool {self._inline != nil}
  ...
  var hasConcept: Bool {self._concept != nil}
...
nonisolated struct ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2: SwiftProtobuf.ExtensibleMessage, @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var requiredNestedMessage: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.NestedMessage {
    get {_storage._requiredNestedMessage ?? ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.NestedMessage()}
    set {_uniqueStorage()._requiredNestedMessage = newValue}
  }
  /// Returns true if `requiredNestedMessage` has been explicitly set.
  var hasRequiredNestedMessage: Bool {_storage._requiredNestedMessage != nil}
  ...
  var requiredForeignMessage: ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2 {
    get {_storage._requiredForeignMessage ?? ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2()}
    set {_uniqueStorage()._requiredForeignMessage = newValue}
  }
  /// Returns true if `requiredForeignMessage` has been explicitly set.
  var hasRequiredForeignMessage: Bool {_storage._requiredForeignMessage != nil}
  ...
  var requiredForeignEnum: ProtobufTestMessages_Editions_Proto2_ForeignEnumProto2 {
    get {_storage._requiredForeignEnum ?? .foreignFoo}
    set {_uniqueStorage()._requiredForeignEnum = newValue}
  }
  /// Returns true if `requiredForeignEnum` has been explicitly set.
  var hasRequiredForeignEnum: Bool {_storage._requiredForeignEnum != nil}
  ...
  var recursiveMessage: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2 {
    get {_storage._recursiveMessage ?? ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2()}
    set {_uniqueStorage()._recursiveMessage = newValue}
  }
  /// Returns true if `recursiveMessage` has been explicitly set.
  var hasRecursiveMessage: Bool {_storage._recursiveMessage != nil}
  ...
  var optionalRecursiveMessage: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2 {
    get {_storage._optionalRecursiveMessage ?? ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2()}
    set {_uniqueStorage()._optionalRecursiveMessage = newValue}
  }
  /// Returns true if `optionalRecursiveMessage` has been explicitly set.
  var hasOptionalRecursiveMessage: Bool {_storage._optionalRecursiveMessage != nil}
  ...
  var data: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.DataMessage {
    get {_storage._data ?? ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.DataMessage()}
    set {_uniqueStorage()._data = newValue}
  }
  /// Returns true if `data` has been explicitly set.
  var hasData: Bool {_storage._data != nil}
  ...
  nonisolated struct NestedMessage: @unchecked Sendable {
    ...
    var corecursive: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2 {
      get {_storage._corecursive ?? ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2()}
      set {_uniqueStorage()._corecursive = newValue}
    }
    /// Returns true if `corecursive` has been explicitly set.
    var hasCorecursive: Bool {_storage._corecursive != nil}
    ...
    var hasOptionalCorecursive: Bool {_storage._optionalCorecursive != nil}
...
nonisolated struct ProtobufTestMessages_Editions_Proto2_TestLargeOneof: Sendable {
  ...
  var largeOneof: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.OneOf_LargeOneof? = nil

  var a1: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A1 {
    get {
      if case .a1(let v)? = largeOneof {return v}
      return ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A1()
    }
  ...
  var a2: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A2 {
    get {
      ...
      return ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A2()
    }
  ...
  var a3: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A3 {
    get {
      ...
      return ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A3()
    }
  ...
  var a4: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A4 {
    get {
      ...
      return ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A4()
    }
  ...
  var a5: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A5 {
    get {
      ...
      return ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A5()
    }
  ...
  nonisolated enum OneOf_LargeOneof: Equatable, Sendable {
  ...
  nonisolated struct A1: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  nonisolated struct A2: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  nonisolated struct A3: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  nonisolated struct A4: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  nonisolated struct A5: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrect {
  ...
  var ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2_MessageSetCorrectExtension1_messageSetExtension: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension1 {
    get {return getExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension1.Extensions.message_set_extension) ?? ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension1()}
    set {setExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension1.Extensions.message_set_extension, value: newValue)}
  }
  ...
  var hasProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2_MessageSetCorrectExtension1_messageSetExtension: Bool {
    return hasExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension1.Extensions.message_set_extension)
  }
  ...
  mutating func clearProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2_MessageSetCorrectExtension1_messageSetExtension() {
    clearExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension1.Extensions.message_set_extension)
  }
  ...
  var ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2_MessageSetCorrectExtension2_messageSetExtension: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension2 {
    get {return getExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension2.Extensions.message_set_extension) ?? ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension2()}
    set {setExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension2.Extensions.message_set_extension, value: newValue)}
  }
  ...
  /// has been explicitly set.
  var hasProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2_MessageSetCorrectExtension2_messageSetExtension: Bool {
    return hasExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension2.Extensions.message_set_extension)
  }
  ...
  mutating func clearProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2_MessageSetCorrectExtension2_messageSetExtension() {
    clearExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension2.Extensions.message_set_extension)
  }
}
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2 {
  ...
  var ProtobufTestMessages_Editions_Proto2_extensionInt32: Int32 {
    get {return getExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_Extensions_extension_int32) ?? 0}
    set {setExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_Extensions_extension_int32, value: newValue)}
  }
  /// Returns true if extension `ProtobufTestMessages_Editions_Proto2_Extensions_extension_int32`
  /// has been explicitly set.
  var hasProtobufTestMessages_Editions_Proto2_extensionInt32: Bool {
    return hasExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_Extensions_extension_int32)
  }
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect {
  ...
  var ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2_MessageSetCorrectExtension1_messageSetExtension: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension1 {
    get {return getExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension1.Extensions.message_set_extension) ?? ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension1()}
    set {setExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension1.Extensions.message_set_extension, value: newValue)}
  }
  ...
  /// has been explicitly set.
  var hasProtobufTestMessages_Editions_Proto2_TestAllTypesProto2_MessageSetCorrectExtension1_messageSetExtension: Bool {
    return hasExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension1.Extensions.message_set_extension)
  }
  ...
  var ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2_MessageSetCorrectExtension2_messageSetExtension: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension2 {
    get {return getExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension2.Extensions.message_set_extension) ?? ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension2()}
    set {setExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension2.Extensions.message_set_extension, value: newValue)}
  }
  ...
  /// has been explicitly set.
  var hasProtobufTestMessages_Editions_Proto2_TestAllTypesProto2_MessageSetCorrectExtension2_messageSetExtension: Bool {
    return hasExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension2.Extensions.message_set_extension)
  }
  ...
  mutating func clearProtobufTestMessages_Editions_Proto2_TestAllTypesProto2_MessageSetCorrectExtension2_messageSetExtension() {
    clearExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension2.Extensions.message_set_extension)
  }
  ...
  var ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2_ExtensionWithOneof_extensionWithOneof: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof {
    get {return getExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof.Extensions.extension_with_oneof) ?? ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof()}
    set {setExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof.Extensions.extension_with_oneof, value: newValue)}
  }
  ...
  /// has been explicitly set.
  var hasProtobufTestMessages_Editions_Proto2_TestAllTypesProto2_ExtensionWithOneof_extensionWithOneof: Bool {
    return hasExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof.Extensions.extension_with_oneof)
  }
  ...
  /// Subsequent reads from it will return its default value.
  mutating func clearProtobufTestMessages_Editions_Proto2_TestAllTypesProto2_ExtensionWithOneof_extensionWithOneof() {
    clearExtensionValue(ext: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof.Extensions.extension_with_oneof)
  }
...
nonisolated let ProtobufTestMessages_Editions_Proto2_TestMessagesProto2Editions_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
nonisolated let ProtobufTestMessages_Editions_Proto2_Extensions_extension_int32 = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufInt32>, ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2>(
  _protobuf_fieldNumber: 120,
  fieldName: "protobuf_test_messages.editions.proto2.extension_int32"
)

nonisolated let ProtobufTestMessages_Editions_Proto2_Extensions_extension_string = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufString>, ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2>(
  _protobuf_fieldNumber: 133,
  fieldName: "protobuf_test_messages.editions.proto2.extension_string"
)

nonisolated let ProtobufTestMessages_Editions_Proto2_Extensions_extension_bytes = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufBytes>, ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2>(
  _protobuf_fieldNumber: 134,
  fieldName: "protobuf_test_messages.editions.proto2.extension_bytes"
)

nonisolated let ProtobufTestMessages_Editions_Proto2_Extensions_GroupField = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalGroupExtensionField<ProtobufTestMessages_Editions_Proto2_GroupField>, ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2>(
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension1 {
  enum Extensions {
    static let message_set_extension = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension1>, ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect>(
      _protobuf_fieldNumber: 1547769,
      fieldName: "protobuf_test_messages.editions.proto2.TestAllTypesProto2.MessageSetCorrectExtension1"
    )
  }
}
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension2 {
  enum Extensions {
    static let message_set_extension = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension2>, ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect>(
      _protobuf_fieldNumber: 4135312,
      fieldName: "protobuf_test_messages.editions.proto2.TestAllTypesProto2.MessageSetCorrectExtension2"
    )
  }
}
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof {
  enum Extensions {
    static let extension_with_oneof = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof>, ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect>(
      _protobuf_fieldNumber: 123456789,
      fieldName: "protobuf_test_messages.editions.proto2.TestAllTypesProto2.ExtensionWithOneof"
    )
  }
}
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension1 {
  enum Extensions {
    static let message_set_extension = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension1>, ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrect>(
      _protobuf_fieldNumber: 1547769,
      fieldName: "protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2.MessageSetCorrectExtension1"
    )
  }
}
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension2 {
  enum Extensions {
    static let message_set_extension = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension2>, ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrect>(
      _protobuf_fieldNumber: 4135312,
      fieldName: "protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2.MessageSetCorrectExtension2"
    )
  }
}
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _optionalNestedMessage: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage? = nil
    var _optionalForeignMessage: ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2? = nil
    var _optionalNestedEnum: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedEnum? = nil
    var _optionalForeignEnum: ProtobufTestMessages_Editions_Proto2_ForeignEnumProto2? = nil
    var _optionalStringPiece: String? = nil
    var _optionalCord: String? = nil
    var _recursiveMessage: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2? = nil
    ...
    var _repeatedNestedMessage: [ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage] = []
    ...
    var _repeatedForeignEnum: [ProtobufTestMessages_Editions_Proto2_ForeignEnumProto2] = []
    ...
    var _packedNestedEnum: [ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedEnum] = []
    ...
    var _unpackedNestedEnum: [ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedEnum] = []
    ...
    var _mapInt32NestedMessage: Dictionary<Int32,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage> = [:]
    ...
    var _mapStringNestedMessage: Dictionary<String,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage> = [:]
    var _mapStringForeignMessage: Dictionary<String,ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2> = [:]
    var _mapStringNestedEnum: Dictionary<String,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedEnum> = [:]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 71: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage>.self, value: &_storage._mapStringNestedMessage) }()
        case 72: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2>.self, value: &_storage._mapStringForeignMessage) }()
        case 73: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedEnum>.self, value: &_storage._mapStringNestedEnum) }()
        case 74: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto2_ForeignEnumProto2>.self, value: &_storage._mapStringForeignEnum) }()
        ...
        case 103: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufInt32,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage>.self, value: &_storage._mapInt32NestedMessage) }()
        ...
        case 112: try {
          var v: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage?
        ...
        case 119: try {
          var v: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedEnum?
        ...
        case 120..<201:
          try { try decoder.decodeExtensionField(values: &_protobuf_extensionFieldValues, messageType: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.self, fieldNumber: fieldNumber) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._mapStringNestedMessage.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage>.self, value: _storage._mapStringNestedMessage, fieldNumber: 71)
      }
      if !_storage._mapStringForeignMessage.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2>.self, value: _storage._mapStringForeignMessage, fieldNumber: 72)
      }
      if !_storage._mapStringNestedEnum.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedEnum>.self, value: _storage._mapStringNestedEnum, fieldNumber: 73)
      }
      if !_storage._mapStringForeignEnum.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufEnumMap<SwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_Proto2_ForeignEnumProto2>.self, value: _storage._mapStringForeignEnum, fieldNumber: 74)
      }
      ...
      if !_storage._mapInt32NestedMessage.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufInt32,ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage>.self, value: _storage._mapInt32NestedMessage, fieldNumber: 103)
      }
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2, rhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2) -> Bool {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedEnum: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.protoMessageName + ".NestedMessage"
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage, rhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.NestedMessage) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.DataMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.protoMessageName + ".Data"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}J\u{3}group_int32\0\u{3}group_uint32\0")
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.DataMessage, rhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.DataMessage) -> Bool {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MultiWordGroupField: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}M\u{3}group_int32\0\u{3}group_uint32\0")
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    try decoder.decodeExtensionFieldsAsMessageSet(values: &_protobuf_extensionFieldValues, messageType: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect.self)
  }
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect, rhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrect) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    if lhs._protobuf_extensionFieldValues != rhs._protobuf_extensionFieldValues {return false}
    return true
  }
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension1: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.protoMessageName + ".MessageSetCorrectExtension1"
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension1, rhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension1) -> Bool {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.protoMessageName + ".MessageSetCorrectExtension2"
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension2, rhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.MessageSetCorrectExtension2) -> Bool {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.protoMessageName + ".ExtensionWithOneof"
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof, rhs: ProtobufTestMessages_Editions_Proto2_TestAllTypesProto2.ExtensionWithOneof) -> Bool {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_GroupField: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GroupField"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}z\u{1}group_int32\0\u{3}group_uint32\0")
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_UnknownToTestAllTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".UnknownToTestAllTypes"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}i\u{f}optional_int32\0\u{3}optional_string\0\u{3}nested_message\0\u{7}OptionalGroup\0\u{4}\u{2}optional_bool\0\u{4}\u{5}repeated_int32\0")
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_UnknownToTestAllTypes, rhs: ProtobufTestMessages_Editions_Proto2_UnknownToTestAllTypes) -> Bool {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_UnknownToTestAllTypes.OptionalGroup: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_UnknownToTestAllTypes.protoMessageName + ".OptionalGroup"
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_UnknownToTestAllTypes.OptionalGroup, rhs: ProtobufTestMessages_Editions_Proto2_UnknownToTestAllTypes.OptionalGroup) -> Bool {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_NullHypothesisProto2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_NullHypothesisProto2, rhs: ProtobufTestMessages_Editions_Proto2_NullHypothesisProto2) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

nonisolated extension ProtobufTestMessages_Editions_Proto2_EnumOnlyProto2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_EnumOnlyProto2, rhs: ProtobufTestMessages_Editions_Proto2_EnumOnlyProto2) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

nonisolated extension ProtobufTestMessages_Editions_Proto2_EnumOnlyProto2.BoolEnum: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0kFalse\0\u{1}kTrue\0")
}

nonisolated extension ProtobufTestMessages_Editions_Proto2_OneStringProto2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_OneStringProto2, rhs: ProtobufTestMessages_Editions_Proto2_OneStringProto2) -> Bool {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_ProtoWithKeywords: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ProtoWithKeywords"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}inline\0\u{1}concept\0\u{1}requires\0")
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_ProtoWithKeywords, rhs: ProtobufTestMessages_Editions_Proto2_ProtoWithKeywords) -> Bool {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".TestAllRequiredTypesProto2"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}required_int32\0\u{3}required_int64\0\u{3}required_uint32\0\u{3}required_uint64\0\u{3}required_sint32\0\u{3}required_sint64\0\u{3}required_fixed32\0\u{3}required_fixed64\0\u{3}required_sfixed32\0\u{3}required_sfixed64\0\u{3}required_float\0\u{3}required_double\0\u{3}required_bool\0\u{3}required_string\0\u{3}required_bytes\0\u{4}\u{3}required_nested_message\0\u{3}required_foreign_message\0\u{4}\u{2}required_nested_enum\0\u{3}required_foreign_enum\0\u{4}\u{2}required_string_piece\0\u{3}required_cord\0\u{4}\u{2}recursive_message\0\u{3}optional_recursive_message\0\u{8}m\u{2}Data\0\u{4}(default_int32\0\u{3}default_int64\0\u{3}default_uint32\0\u{3}default_uint64\0\u{3}default_sint32\0\u{3}default_sint64\0\u{3}default_fixed32\0\u{3}default_fixed64\0\u{3}default_sfixed32\0\u{3}default_sfixed64\0\u{3}default_float\0\u{3}default_double\0\u{3}default_bool\0\u{3}default_string\0\u{3}default_bytes\0\u{c}h\u{f}hL\u{2}")
  ...
  fileprivate class _StorageClass {
    ...
    var _requiredNestedMessage: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.NestedMessage? = nil
    var _requiredForeignMessage: ProtobufTestMessages_Editions_Proto2_ForeignMessageProto2? = nil
    var _requiredNestedEnum: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.NestedEnum? = nil
    var _requiredForeignEnum: ProtobufTestMessages_Editions_Proto2_ForeignEnumProto2? = nil
    var _requiredStringPiece: String? = nil
    var _requiredCord: String? = nil
    var _recursiveMessage: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2? = nil
    var _optionalRecursiveMessage: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2? = nil
    var _data: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.DataMessage? = nil
    var _defaultInt32: Int32? = nil
    var _defaultInt64: Int64? = nil
    var _defaultUint32: UInt32? = nil
    var _defaultUint64: UInt64? = nil
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 255: try { try decoder.decodeSingularBytesField(value: &_storage._defaultBytes) }()
        case 120..<201:
          try { try decoder.decodeExtensionField(values: &_protobuf_extensionFieldValues, messageType: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.self, fieldNumber: fieldNumber) }()
        default: break
        }
      }
    }
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2, rhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.NestedEnum: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\u{7f}\u{7f}\u{7f}\u{7f}\u{7f}\u{3}NEG\0\u{1}FOO\0\u{1}BAR\0\u{1}BAZ\0")
}

nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.NestedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.protoMessageName + ".NestedMessage"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}a\0\u{1}corecursive\0\u{3}optional_corecursive\0")
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.NestedMessage, rhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.NestedMessage) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.DataMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.protoMessageName + ".Data"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}J\u{3}group_int32\0\u{3}group_uint32\0")
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.DataMessage, rhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.DataMessage) -> Bool {
    if lhs._groupInt32 != rhs._groupInt32 {return false}
    if lhs._groupUint32 != rhs._groupUint32 {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrect: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.protoMessageName + ".MessageSetCorrect"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    try decoder.decodeExtensionFieldsAsMessageSet(values: &_protobuf_extensionFieldValues, messageType: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrect.self)
  }
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrect, rhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrect) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    if lhs._protobuf_extensionFieldValues != rhs._protobuf_extensionFieldValues {return false}
    return true
  }
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension1: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.protoMessageName + ".MessageSetCorrectExtension1"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\u{19}str\0")
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension1, rhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension1) -> Bool {
    if lhs._str != rhs._str {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.protoMessageName + ".MessageSetCorrectExtension2"
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension2, rhs: ProtobufTestMessages_Editions_Proto2_TestAllRequiredTypesProto2.MessageSetCorrectExtension2) -> Bool {
    if lhs._i != rhs._i {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestLargeOneof: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".TestLargeOneof"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}a1\0\u{1}a2\0\u{1}a3\0\u{1}a4\0\u{1}a5\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A1?
        var hadOneofValue = false
      ...
      case 2: try {
        var v: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A2?
        var hadOneofValue = false
        if let current = self.largeOneof {
          hadOneofValue = true
      ...
      case 3: try {
        var v: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A3?
        var hadOneofValue = false
        if let current = self.largeOneof {
          hadOneofValue = true
      ...
      case 4: try {
        var v: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A4?
        var hadOneofValue = false
        if let current = self.largeOneof {
          hadOneofValue = true
      ...
      case 5: try {
        var v: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A5?
        var hadOneofValue = false
        if let current = self.largeOneof {
          hadOneofValue = true
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof, rhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof) -> Bool {
...
nonisolated extension ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A1: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestLargeOneof.protoMessageName + ".A1"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A1, rhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A1) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

nonisolated extension ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestLargeOneof.protoMessageName + ".A2"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A2, rhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A2) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

nonisolated extension ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A3: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestLargeOneof.protoMessageName + ".A3"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A3, rhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A3) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

nonisolated extension ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A4: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestLargeOneof.protoMessageName + ".A4"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A4, rhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A4) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

nonisolated extension ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A5: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ProtobufTestMessages_Editions_Proto2_TestLargeOneof.protoMessageName + ".A5"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A5, rhs: ProtobufTestMessages_Editions_Proto2_TestLargeOneof.A5) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
