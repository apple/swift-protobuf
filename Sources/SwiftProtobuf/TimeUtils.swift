...
internal func timeOfDayFromSecondsSince1970(seconds: Int64)
      -> (hh: Int32, mm: Int32, ss: Int32) {
...
internal func julianDayNumberFromSecondsSince1970(seconds: Int64) -> Int64 {
      ...
      return div(
            seconds + 2_440_588 * Int64(secondsPerDay), Int64(secondsPerDay))
}

internal func gregorianDateFromSecondsSince1970(seconds: Int64)
      -> (YY: Int32, MM: Int32, DD: Int32) {
