...
public enum Internal {
    ...
    /// A singleton instance of empty data used by the generated code for default values.
    ///
    /// This is a performance enhancement to work around the fact that the `Data` type in
    /// Swift involves a new heap allocation every time an empty instance is initialized,
