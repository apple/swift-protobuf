...
internal struct BinaryDecoder: Decoder {
      ...
      internal init(
            forReadingFrom pointer: UnsafePointer<UInt8>, count: Int,
            options: BinaryDecodingOptions, extensions: ExtensionMap? = nil
      ) {
      ...
      internal init(
            ...
            self.init(
                  forReadingFrom: pointer, count: count,
                  options: parent.options, extensions: parent.extensions)
      ...
      internal mutating func nextFieldNumber() throws -> Int? {
            ...
            if fieldNumber > 0 {
                  if let override = unknownOverride {
                        ...
                        assert(
                              fieldWireFormat != .startGroup && fieldWireFormat
                                    != .endGroup)
                        if unknownData == nil { unknownData = override }
                        else { unknownData!.append(override) }
                        unknownOverride = nil
                  }
                  else if !consumed {
                        if options.discardUnknownFields { try skip() }
                        else {
                              let u = try getRawField()
                              if unknownData == nil { unknownData = u }
                              else { unknownData!.append(u) }
                        }
                  }
            }
                  ...
                  if (c1 & 0x80) == 0 {
                        ...
                        if (c2 & 0x80) == 0 {
                              ...
                              if (c3 & 0x80) == 0 {
                                    ...
                                    if available < 5 {
                                          throw
                                                BinaryDecodingError.malformedProtobuf
                                    }
                                    let c4 = start[4]
                                    if c4 > 15 {
                                          throw
      ...
      {
            guard fieldWireFormat == WireFormat.fixed32 else { return }
            ...
            throws
      {
            ...
            case WireFormat.lengthDelimited:
                  ...
                  if bodyBytes > 0 {
                        ...
                        if bodyBytes % itemSize != 0 || itemCount > UInt64(
                              Int.max)
                        { throw BinaryDecodingError.truncated }
                        value.reserveCapacity(
                              value.count + Int(truncatingIfNeeded: itemCount))
      ...
      internal mutating func decodeSingularDoubleField(value: inout Double)
            throws
      {
            guard fieldWireFormat == WireFormat.fixed64 else { return }
      ...
      {
            guard fieldWireFormat == WireFormat.varint else { return }
            ...
            throws
      {
            ...
            case WireFormat.lengthDelimited:
                  ...
                  var decoder = BinaryDecoder(
                        forReadingFrom: p, count: n, parent: self)
            ...
            throws
      {
            ...
            case WireFormat.lengthDelimited:
                  ...
                  let p = try getFieldBodyBytes(count: &n)
                  value.reserveCapacity(
                        value.count + n / MemoryLayout<UInt32>.size)
                  var decoder = BinaryDecoder(
                        forReadingFrom: p, count: n, parent: self)
                  var i: UInt32 = 0
                  while !decoder.complete {
            ...
            throws
      {
            ...
            case WireFormat.lengthDelimited:
                  ...
                  let p = try getFieldBodyBytes(count: &n)
                  value.reserveCapacity(
                        value.count + n / MemoryLayout<UInt64>.size)
                  var decoder = BinaryDecoder(
                        forReadingFrom: p, count: n, parent: self)
                  var i: UInt64 = 0
                  while !decoder.complete {
            ...
            throws
      {
            ...
            case WireFormat.lengthDelimited:
                  ...
                  let p = try getFieldBodyBytes(count: &n)
                  value.reserveCapacity(
                        value.count + n / MemoryLayout<Int32>.size)
                  var decoder = BinaryDecoder(
                        forReadingFrom: p, count: n, parent: self)
                  var i: Int32 = 0
                  while !decoder.complete {
            ...
            throws
      {
            ...
            case WireFormat.lengthDelimited:
                  ...
                  let p = try getFieldBodyBytes(count: &n)
                  value.reserveCapacity(
                        value.count + n / MemoryLayout<Int64>.size)
                  var decoder = BinaryDecoder(
                        forReadingFrom: p, count: n, parent: self)
                  var i: Int64 = 0
                  while !decoder.complete {
      ...
      internal mutating func decodeSingularStringField(value: inout String)
            throws
      {
            guard fieldWireFormat == WireFormat.lengthDelimited else { return }
            var n: Int = 0
            let p = try getFieldBodyBytes(count: &n)
            ...
            else { throw BinaryDecodingError.invalidUTF8 }
      }
      ...
      internal mutating func decodeSingularEnumField<E: Enum>(value: inout E?)
            throws where E.RawValue == Int {
            guard fieldWireFormat == WireFormat.varint else { return }
            let varint = try decodeVarint()
      ...
      internal mutating func decodeRepeatedEnumField<E: Enum>(value: inout [E])
            throws where E.RawValue == Int {
            switch fieldWireFormat {
            case WireFormat.varint:
                  let varint = try decodeVarint()
            ...
            case WireFormat.lengthDelimited:
                  ...
                  while !subdecoder.complete {
                        ...
                        if let v = E(rawValue: Int(i32)) { value.append(v) }
                  ...
                  if let extras = extras {
                        ...
                        let fieldSize = Varint.encodedSize(
                              of: fieldTag.rawValue) + Varint.encodedSize(
                              of: Int64(bodySize)) + bodySize
                        var field = Data(count: fieldSize)
                        field.withUnsafeMutableBytes {
                              (pointer: UnsafeMutablePointer<UInt8>) in
                              var encoder = BinaryEncoder(
                                    forWritingInto: pointer)
      ...
      internal mutating func decodeSingularMessageField<M: Message>(
            value: inout M?
      ) throws {
            guard fieldWireFormat == WireFormat.lengthDelimited else { return }
            var count: Int = 0
            let p = try getFieldBodyBytes(count: &count)
            if value == nil { value = M() }
            var subDecoder = BinaryDecoder(
                  forReadingFrom: p, count: count, parent: self)
            try subDecoder.decodeFullMessage(message: &value!)
            consumed = true
      }

      internal mutating func decodeRepeatedMessageField<M: Message>(
            value: inout [M]
      ) throws {
            guard fieldWireFormat == WireFormat.lengthDelimited else { return }
            var count: Int = 0
      ...
      internal mutating func decodeFullMessage<M: Message>(message: inout M)
            throws
      {
            try incrementRecursionDepth()
            try message.decodeMessage(decoder: &self)
            decrementRecursionDepth()
            guard complete else { throw BinaryDecodingError.trailingGarbage }
            if let unknownData = unknownData {
                  message.unknownFields.append(protobufData: unknownData)
            }
      }

      internal mutating func decodeSingularGroupField<G: Message>(
            value: inout G?
      ) throws {
            var group = value ?? G()
      ...
      internal mutating func decodeRepeatedGroupField<G: Message>(
            value: inout [G]
      ) throws {
            var group = G()
            if try decodeFullGroup(group: &group, fieldNumber: fieldNumber) {
      ...
      private mutating func decodeFullGroup<G: Message>(
            group: inout G, fieldNumber: Int
      ) throws -> Bool {
            guard fieldWireFormat == WireFormat.startGroup else { return false }
            ...
            guard subDecoder.fieldNumber == fieldNumber
                  && subDecoder.fieldWireFormat == .endGroup
            else { throw BinaryDecodingError.truncated }
      ...
      internal mutating func decodeMapField<KeyType, ValueType: MapValueType>(
            ...
            while let tag = try subdecoder.getTag() {
                  ...
                  case 2:
                        try ValueType.decodeSingular(
                              value: &v, from: &subdecoder)
            ...
            value[k ?? KeyType.proto3DefaultValue] = v
                  ?? ValueType.proto3DefaultValue
            consumed = true
      }
      ...
      internal mutating func decodeExtensionField(
            values: inout ExtensionFieldValueSet, messageType: Message.Type,
            fieldNumber: Int
      ) throws {
            if let ext = extensions?[messageType, fieldNumber] {
                  try decodeExtensionField(
                        values: &values, messageType: messageType,
                        fieldNumber: fieldNumber, messageExtension: ext)
            }
      }
      ...
      private mutating func decodeExtensionField(
            values: inout ExtensionFieldValueSet, messageType: Message.Type,
            fieldNumber: Int, messageExtension ext: AnyMessageExtension
      ) throws {
            assert(!consumed)
            ...
            else { fieldValue = try ext._protobuf_newField(decoder: &self) }
            if consumed {
                  if fieldValue != nil { values[fieldNumber] = fieldValue }
                  else {
      ...
      internal mutating func decodeExtensionFieldsAsMessageSet(
            ...
            while let fieldNumber = try self.nextFieldNumber() {
                  guard fieldNumber == WireFormat.MessageSet.FieldNumbers.item
                        && fieldWireFormat == WireFormat.startGroup
                  else { continue }
                  ...
                  case .malformed: throw BinaryDecodingError.malformedProtobuf
                  }
      ...
      private mutating func decodeMessageSetItem(
            ...
            while let fieldNumber = try self.nextFieldNumber() {
                  ...
                  case WireFormat.MessageSet.FieldNumbers.typeId:
                        ...
                        try decodeSingularInt32Field(
                              value: &extensionFieldNumber)
                        if extensionFieldNumber == 0 { return .malformed }
                        guard
                              let ext = extensions?[
                              messageType, Int(extensionFieldNumber)]
                        else {
                        ...
                        if let data = fieldData {
                              ...
                              if !wasDecoded { return .malformed }
                              fieldData = nil
                        }
                  ...
                  case WireFormat.MessageSet.FieldNumbers.message:
                        if let ext = msgExtension {
                              ...
                              if fieldData == nil {
                                    ...
                                    let payloadSize = Varint.encodedSize(
                                          of: Int64(data.count)) + data.count
                                    ...
                                    guard fieldWireFormat == .lengthDelimited
      ...
      private mutating func skipOver(tag: FieldTag) throws {
            ...
            case .varint:
                  if available < 1 { throw BinaryDecodingError.truncated }
                  var c = p[0]
                  while (c & 0x80) != 0 {
                        p += 1
                        available -= 1
                  ...
                  available -= 1
            case .fixed64:
                  if available < 8 { throw BinaryDecodingError.truncated }
                  p += 8
                  available -= 8
            ...
            case .startGroup:
                  ...
                  while true {
                        if let innerTag = try getTagWithoutUpdatingFieldStart()
                        {
                              ...
                              else { try skipOver(tag: innerTag) }
                        }
                        else { throw BinaryDecodingError.truncated }
                  }
            case .endGroup: throw BinaryDecodingError.malformedProtobuf
            case .fixed32:
                  if available < 4 { throw BinaryDecodingError.truncated }
                  p += 4
                  available -= 4
            }
      }
      ...
      private mutating func getTagWithoutUpdatingFieldStart() throws
            -> FieldTag?
      {
            if available < 1 { return nil }
            let t = try decodeVarint()
            if t < UInt64(UInt32.max) {
                  guard
                        let tag = FieldTag(
                        rawValue: UInt32(truncatingIfNeeded: t))
                  else { throw BinaryDecodingError.malformedProtobuf }
      ...
      private mutating func decodeFourByteNumber<T>(value: inout T) throws {
            ...
            withUnsafeMutablePointer(to: &value) { ip -> Void in
                  let dest = UnsafeMutableRawPointer(ip).assumingMemoryBound(
                        to: UInt8.self)
                  let src = UnsafeRawPointer(p).assumingMemoryBound(
                        to: UInt8.self)
      ...
      private mutating func getFieldBodyBytes(count: inout Int) throws
            -> UnsafePointer<UInt8> {
