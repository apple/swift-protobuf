...
extension ExtensibleMessage {
      public mutating func setExtensionValue<F>(
            ext: MessageExtension<F, Self>, value: F.ValueType
      ) {
            _protobuf_extensionFieldValues[ext.fieldNumber] = F(
                  protobufExtension: ext, value: value)
      }

      public func getExtensionValue<F>(ext: MessageExtension<F, Self>)
            -> F.ValueType?
      {
            if let fieldValue = _protobuf_extensionFieldValues[ext.fieldNumber]
                  as? F
      ...
      public mutating func clearExtensionValue<F>(
            ext: MessageExtension<F, Self>
