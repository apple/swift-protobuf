...
internal struct JSONEncodingVisitor: Visitor {
      ...
      var dataResult: Data { return encoder.dataResult }

      /// The JSON text produced by the visitor, as a String.
      internal var stringResult: String { return encoder.stringResult }
      ...
      init(type: Message.Type, options: JSONEncodingOptions) throws {
            ...
            else { throw JSONEncodingError.missingFieldNames }
      ...
      mutating func startArray() { encoder.startArray() }

      mutating func endArray() { encoder.endArray() }

      mutating func startObject() { encoder.startObject() }

      mutating func endObject() { encoder.endObject() }
            ...
            throws
      {
            ...
            else { encoder.putEnumInt(value: value.rawValue) }
      }
      ...
      mutating func visitRepeatedEnumField<E: Enum>(
            ...
            try _visitRepeated(value: value, fieldNumber: fieldNumber) {
                  ...
                  else { encoder.putEnumInt(value: v.rawValue) }
            }
      }
      ...
      mutating func visitMapField<KeyType, ValueType: MapValueType>(
            ...
            try startField(for: fieldNumber)
            encoder.append(text: "{")
            var mapVisitor = JSONMapEncodingVisitor(
                  encoder: encoder, options: options)
            for (k, v) in value {
                  try KeyType.visitSingular(
                        value: k, fieldNumber: 1, with: &mapVisitor)
                  try ValueType.visitSingular(
                        value: v, fieldNumber: 2, with: &mapVisitor)
            }
      ...
      mutating func visitMapField<KeyType, ValueType>(
            ...
            for (k, v) in value {
                  try KeyType.visitSingular(
                        value: k, fieldNumber: 1, with: &mapVisitor)
                  try mapVisitor.visitSingularEnumField(
      ...
      mutating func visitMapField<KeyType, ValueType>(
            ...
            for (k, v) in value {
                  try KeyType.visitSingular(
                        value: k, fieldNumber: 1, with: &mapVisitor)
                  try mapVisitor.visitSingularMessageField(
                        value: v, fieldNumber: 2)
            }
            encoder = mapVisitor.encoder
            encoder.append(text: "}")
