...
extension Message {
    ...
    /// TODO: Delete this when all of the other test protos are generated with
    ...
    // TODO: None of the generated protos use these anymore. Once we've removed
    // code in the runtime that depends on these requirements existing in the
    // `Message` protocol, delete these default implementations and the protocol
    // requirements.
