...
internal struct BinaryEncoder {
      ...
      private mutating func append(
            contentsOf bufferPointer: UnsafeBufferPointer<UInt8>
      ) {
      ...
      mutating func appendUnknown(data: Data) { append(contentsOf: data) }

      mutating func startField(fieldNumber: Int, wireFormat: WireFormat) {
            startField(
                  tag: FieldTag(
                        fieldNumber: fieldNumber, wireFormat: wireFormat))
      }
      ...
      mutating func putVarInt(value: Int) { putVarInt(value: Int64(value)) }
      ...
      mutating func putBoolValue(value: Bool) { append(value ? 1 : 0) }
