...
public struct TextFormatDecodingOptions: Sendable {
    ...
    /// If unknown fields in the text format should be ignored.
    ///
    /// If they aren't ignored, an error is raised if one is encountered.
    ///
    /// Note: This is a lossy option, enabling it means part of the TextFormat
    /// is silently skipped.
    public var ignoreUnknownFields: Bool = false

    /// If unknown extension fields in the text format should be ignored.
    ///
    /// If they aren't ignored, an error is raised if one is encountered.
    ///
    /// Note: This is a lossy option, enabling it means part of the TextFormat
