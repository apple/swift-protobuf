...
public struct BinaryEncodingOptions: Sendable {
    ...
    /// It may NOT remain stable over time. It is unstable across
    ...
    ///
    /// Requesting deterministic serialization sorts map entries by keys in
    /// lexicographical order. This is an implementation detail
