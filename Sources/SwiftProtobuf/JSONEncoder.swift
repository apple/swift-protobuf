...
internal struct JSONEncoder {
      ...
      internal mutating func startField(name: _NameMap.Name) {
            if let s = separator { data.append(s) }
      ...
      internal mutating func comma() { data.append(asciiComma) }
      ...
      internal mutating func putNullValue() { append(staticText: "null") }
      ...
      internal mutating func putFloatValue(value: Float) {
            if value.isNaN { append(staticText: "\"NaN\"") }
                  ...
                  if value < 0 { append(staticText: "\"-Infinity\"") }
                  else { append(staticText: "\"Infinity\"") }
            }
            else {
      ...
      private mutating func appendUInt(value: UInt64) {
            if value >= 10 { appendUInt(value: value / 10) }
      ...
      internal mutating func putBoolValue(value: Bool) {
            if value { append(staticText: "true") }
            else { append(staticText: "false") }
      }
      ...
      internal mutating func putStringValue(value: String) {
            ...
            for c in value.unicodeScalars {
                  ...
                  case 23...126: data.append(UInt8(truncatingIfNeeded: c.value))
                  case 0x80...0x7ff:
                        data.append(
                              0xc0 + UInt8(truncatingIfNeeded: c.value >> 6))
                        data.append(
