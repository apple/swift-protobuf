...
public protocol ExtensionField: AnyExtensionField, Hashable {
      ...
      init?<D: Decoder>(
            protobufExtension: AnyMessageExtension, decoder: inout D
      ) throws
}
...
public struct OptionalExtensionField<T: FieldType>: ExtensionField {
      ...
      public static func == (
            lhs: OptionalExtensionField, rhs: OptionalExtensionField
      ...
      public var debugDescription: String { return String(reflecting: value) }
      ...
      public mutating func decodeExtensionField<D: Decoder>(decoder: inout D)
            throws
      {
            var v: ValueType?
...
public struct RepeatedExtensionField<T: FieldType>: ExtensionField {
      ...
      public static func == (
            lhs: RepeatedExtensionField, rhs: RepeatedExtensionField
      ) -> Bool { return lhs.value == rhs.value }
      ...
      public var debugDescription: String {
            return "[" + value.map { String(reflecting: $0) }.joined(
                  separator: ",") + "]"
      }
...
public struct PackedExtensionField<T: FieldType>: ExtensionField {
      ...
      public static func == (
            lhs: PackedExtensionField, rhs: PackedExtensionField
      ) -> Bool { return lhs.value == rhs.value }
...
/// Enum extensions
///
public struct OptionalEnumExtensionField<E: Enum>: ExtensionField
where E.RawValue == Int {
      ...
      public static func == (
            lhs: OptionalEnumExtensionField, rhs: OptionalEnumExtensionField
      ) -> Bool { return lhs.value == rhs.value }
...
///
public struct RepeatedEnumExtensionField<E: Enum>: ExtensionField
where E.RawValue == Int {
      public typealias BaseType = E
      public typealias ValueType = [E]
      public var value: ValueType
      ...
      public static func == (
            lhs: RepeatedEnumExtensionField, rhs: RepeatedEnumExtensionField
      ) -> Bool { return lhs.value == rhs.value }
...
/// find a way to collapse the implementations.
///
public struct PackedEnumExtensionField<E: Enum>: ExtensionField
where E.RawValue == Int {
      public typealias BaseType = E
      public typealias ValueType = [E]
      public var value: ValueType
      ...
      public static func == (
            lhs: PackedEnumExtensionField, rhs: PackedEnumExtensionField
      ) -> Bool { return lhs.value == rhs.value }
...
public struct OptionalMessageExtensionField<M: Message & Equatable>: ExtensionField
{
      ...
      public var isInitialized: Bool { return value.isInitialized }
}
...
public struct OptionalGroupExtensionField<G: Message & Hashable>: ExtensionField
{
      ...
      public static func == (
            lhs: OptionalGroupExtensionField, rhs: OptionalGroupExtensionField
      ) -> Bool { return lhs.value == rhs.value }
...
public struct RepeatedGroupExtensionField<G: Message & Hashable>: ExtensionField
{
      ...
      public static func == (
            lhs: RepeatedGroupExtensionField, rhs: RepeatedGroupExtensionField
      ) -> Bool { return lhs.value == rhs.value }
      ...
      public var debugDescription: String {
            return "[" + value.map { $0.debugDescription }.joined(
                  separator: ",") + "]"
      }
