...
struct Swift_Protobuf_TestFieldOrderings: SwiftProtobufCore.ExtensibleMessage {
...
struct Swift_Protobuf_OneofTraversalGeneration: SwiftProtobufCore.ExtensibleMessage {
  // SwiftProtobufCore.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
let Swift_Protobuf_UnittestSwiftFieldorder_Extensions: SwiftProtobufCore.SimpleExtensionMap = [
...
let Swift_Protobuf_Extensions_my_extension_string = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufString>, Swift_Protobuf_TestFieldOrderings>(
  _protobuf_fieldNumber: 50,
  fieldName: "swift.protobuf.my_extension_string"
)

let Swift_Protobuf_Extensions_my_extension_int = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufInt32>, Swift_Protobuf_TestFieldOrderings>(
...
extension Swift_Protobuf_TestFieldOrderings: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
...
extension Swift_Protobuf_TestFieldOrderings.NestedMessage: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
...
extension Swift_Protobuf_OneofTraversalGeneration: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
