...
class Test_Any: XCTestCase {
  ...
  func test_Any() throws {
    ...
    XCTAssertEqual(
      encoded,
      [
        8, 12, 18, 56, 10, 50, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
        115, 46, 99, 111, 109, 47, 112, 114, 111, 116, 111, 98, 117, 102, 95, 117, 110, 105, 116,
        116, 101, 115, 116, 46, 84, 101, 115, 116, 65, 108, 108, 84, 121, 112, 101, 115, 18, 2, 8,
        7,
      ])
  ...
  func test_Any_different_prefix() throws {
    let encoded = Data([
      8, 12, 18, 40, 10, 34, 88, 47, 89, 47, 112, 114, 111, 116, 111, 98, 117, 102, 95, 117, 110,
      105, 116, 116, 101, 115, 116, 46, 84, 101, 115, 116, 65, 108, 108, 84, 121, 112, 101, 115, 18,
      2, 8, 7,
    ])
  ...
  func test_Any_noprefix() throws {
    let encoded = Data([
      8, 12, 18, 37, 10, 31, 47, 112, 114, 111, 116, 111, 98, 117, 102, 95, 117, 110, 105, 116, 116,
      101, 115, 116, 46, 84, 101, 115, 116, 65, 108, 108, 84, 121, 112, 101, 115, 18, 2, 8, 7,
    ])
    let decoded: ProtobufUnittest_TestAny
    do {
      decoded = try ProtobufUnittest_TestAny(serializedData: encoded)
  ...
  func test_Any_shortesttype() throws {
    let encoded = Data([
      8, 12, 18, 36, 10, 30, 112, 114, 111, 116, 111, 98, 117, 102, 95, 117, 110, 105, 116, 116,
      101, 115, 116, 46, 84, 101, 115, 116, 65, 108, 108, 84, 121, 112, 101, 115, 18, 2, 8, 7,
    ])
    let decoded: ProtobufUnittest_TestAny
    do {
  ...
  func test_Any_UserMessage() throws {
    ...
    XCTAssertEqual(
      encoded,
      "{\"int32Value\":12,\"anyValue\":{\"@type\":\"type.googleapis.com/protobuf_unittest.TestAllTypes\",\"optionalInt32\":7}}"
    )
    do {
  ...
  func test_Any_UnknownUserMessage_JSON() throws {
    Google_Protobuf_Any.register(messageType: ProtobufUnittest_TestAllTypes.self)
    let start =
      "{\"int32Value\":12,\"anyValue\":{\"@type\":\"type.googleapis.com/UNKNOWN\",\"optionalInt32\":7}}"
  ...
  func test_Any_UnknownUserMessage_protobuf() throws {
    Google_Protobuf_Any.register(messageType: ProtobufUnittest_TestAllTypes.self)
    let start = Data([
      8, 12, 18, 33, 10, 27, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
      115, 46, 99, 111, 109, 47, 85, 78, 75, 78, 79, 87, 78, 18, 2, 8, 7,
    ])
  ...
  func test_Any_Any() throws {
    let start =
      "{\"optionalAny\":{\"@type\":\"type.googleapis.com/google.protobuf.Any\",\"value\":{\"@type\":\"type.googleapis.com/google.protobuf.Int32Value\",\"value\":1}}}"
    ...
    XCTAssertEqual(
      protobuf,
      Data([
        138, 19, 95, 10, 39, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
        115, 46, 99, 111, 109, 47, 103, 111, 111, 103, 108, 101, 46, 112, 114, 111, 116, 111, 98,
        117, 102, 46, 65, 110, 121, 18, 52, 10, 46, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108,
        101, 97, 112, 105, 115, 46, 99, 111, 109, 47, 103, 111, 111, 103, 108, 101, 46, 112, 114,
  ...
  func test_Any_Duration_JSON_roundtrip() throws {
    let start =
      "{\"optionalAny\":{\"@type\":\"type.googleapis.com/google.protobuf.Duration\",\"value\":\"99.001s\"}}"
    do {
  ...
  func test_Any_Duration_transcode() throws {
    ...
    do {
      ...
      XCTAssertEqual(
        protobuf,
        Data([
          138, 19, 54, 10, 44, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
          115, 46, 99, 111, 109, 47, 103, 111, 111, 103, 108, 101, 46, 112, 114, 111, 116, 111, 98,
          117, 102, 46, 68, 117, 114, 97, 116, 105, 111, 110, 18, 6, 8, 99, 16, 192, 132, 61,
        ]))
      do {
  ...
  func test_Any_FieldMask_transcode() throws {
    ...
    do {
      ...
      XCTAssertEqual(
        protobuf,
        Data([
          138, 19, 68, 10, 45, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
          115, 46, 99, 111, 109, 47, 103, 111, 111, 103, 108, 101, 46, 112, 114, 111, 116, 111, 98,
          117, 102, 46, 70, 105, 101, 108, 100, 77, 97, 115, 107, 18, 19, 10, 3, 102, 111, 111, 10,
          12, 98, 97, 114, 46, 98, 97, 122, 95, 113, 117, 117, 120,
        ]))
      do {
        let redecoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(serializedData: protobuf)
        let json = try redecoded.jsonString()
  ...
  func test_Any_Int32Value_JSON_roundtrip() throws {
    let start =
      "{\"optionalAny\":{\"@type\":\"type.googleapis.com/google.protobuf.Int32Value\",\"value\":1}}"
    do {
      let decoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(jsonString: start)
      XCTAssertNotNil(decoded.optionalAny)
      let anyField = decoded.optionalAny
  ...
  func test_Any_Int32Value_transcode() throws {
    ...
    do {
      ...
      XCTAssertEqual(
        protobuf,
        Data([
          138, 19, 52, 10, 46, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
          115, 46, 99, 111, 109, 47, 103, 111, 111, 103, 108, 101, 46, 112, 114, 111, 116, 111, 98,
          117, 102, 46, 73, 110, 116, 51, 50, 86, 97, 108, 117, 101, 18, 2, 8, 1,
        ]))
      do {
        let redecoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(serializedData: protobuf)
        let json = try redecoded.jsonString()
  ...
  func test_Any_Struct_JSON_roundtrip() throws {
    let start =
      "{\"optionalAny\":{\"@type\":\"type.googleapis.com/google.protobuf.Struct\",\"value\":{\"foo\":1}}}"
    do {
      let decoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(jsonString: start)
      XCTAssertNotNil(decoded.optionalAny)
      let anyField = decoded.optionalAny
  ...
  func test_Any_Struct_transcode() throws {
    ...
    do {
      ...
      XCTAssertEqual(
        protobuf,
        Data([
          138, 19, 64, 10, 42, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
          115, 46, 99, 111, 109, 47, 103, 111, 111, 103, 108, 101, 46, 112, 114, 111, 116, 111, 98,
          117, 102, 46, 83, 116, 114, 117, 99, 116, 18, 18, 10, 16, 10, 3, 102, 111, 111, 18, 9, 17,
          0, 0, 0, 0, 0, 0, 240, 63,
        ]))
      do {
        let redecoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(serializedData: protobuf)
  ...
  func test_Any_Timestamp_JSON_roundtrip() throws {
    let start =
      "{\"optionalAny\":{\"@type\":\"type.googleapis.com/google.protobuf.Timestamp\",\"value\":\"1970-01-01T00:00:01Z\"}}"
    do {
      let decoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(jsonString: start)
      XCTAssertNotNil(decoded.optionalAny)
      let anyField = decoded.optionalAny
  ...
  func test_Any_Timestamp_transcode() throws {
    let start =
      "{\"optionalAny\":{\"@type\":\"type.googleapis.com/google.protobuf.Timestamp\",\"value\":\"1970-01-01T00:00:01.000000001Z\"}}"
    do {
      let decoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(jsonString: start)
      let protobuf = try decoded.serializedData()
      XCTAssertEqual(
        protobuf,
        Data([
          138, 19, 53, 10, 45, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
          115, 46, 99, 111, 109, 47, 103, 111, 111, 103, 108, 101, 46, 112, 114, 111, 116, 111, 98,
          117, 102, 46, 84, 105, 109, 101, 115, 116, 97, 109, 112, 18, 4, 8, 1, 16, 1,
        ]))
      do {
        let redecoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(serializedData: protobuf)
        let json = try redecoded.jsonString()
  ...
  func test_Any_ListValue_JSON_roundtrip() throws {
    ...
    do {
      ...
      do {
        ...
        XCTAssertEqual(
          unpacked.values,
          [Google_Protobuf_Value(stringValue: "foo"), Google_Protobuf_Value(numberValue: 1)])
      } catch {
        XCTFail("Failed to unpack \(anyField)")
      }
  ...
  func test_Any_ListValue_transcode() throws {
    let start =
      "{\"optionalAny\":{\"@type\":\"type.googleapis.com/google.protobuf.ListValue\",\"value\":[1.0,\"abc\"]}}"
    do {
      let decoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(jsonString: start)
      let protobuf = try decoded.serializedData()
      XCTAssertEqual(
        protobuf,
        Data([
          138, 19, 67, 10, 45, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
          115, 46, 99, 111, 109, 47, 103, 111, 111, 103, 108, 101, 46, 112, 114, 111, 116, 111, 98,
          117, 102, 46, 76, 105, 115, 116, 86, 97, 108, 117, 101, 18, 18, 10, 9, 17, 0, 0, 0, 0, 0,
          0, 240, 63, 10, 5, 26, 3, 97, 98, 99,
        ]))
      do {
        let redecoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(serializedData: protobuf)
        let json = try redecoded.jsonString()
  ...
  func test_Any_Value_struct_JSON_roundtrip() throws {
    ...
    let start1 =
      "{\"optionalAny\":{\"@type\":\"type.googleapis.com/google.protobuf.Value\",\"value\":{\"foo\":1}}}"
    do {
  ...
  func test_Any_Value_struct_transcode() throws {
    ...
    do {
      ...
      XCTAssertEqual(
        protobuf,
        Data([
          138, 19, 65, 10, 41, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
          115, 46, 99, 111, 109, 47, 103, 111, 111, 103, 108, 101, 46, 112, 114, 111, 116, 111, 98,
          117, 102, 46, 86, 97, 108, 117, 101, 18, 20, 42, 18, 10, 16, 10, 3, 102, 111, 111, 18, 9,
          17, 0, 0, 0, 0, 0, 0, 240, 63,
        ]))
      do {
        let redecoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(serializedData: protobuf)
        let json = try redecoded.jsonString()
  ...
  func test_Any_Value_int_JSON_roundtrip() throws {
    ...
    let start2 =
      "{\"optionalAny\":{\"@type\":\"type.googleapis.com/google.protobuf.Value\",\"value\":1}}"
    do {
  ...
  func test_Any_Value_int_transcode() throws {
    let start =
      "{\"optionalAny\":{\"@type\":\"type.googleapis.com/google.protobuf.Value\",\"value\":1.0}}"
    do {
      let decoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(jsonString: start)
      let protobuf = try decoded.serializedData()
      XCTAssertEqual(
        protobuf,
        Data([
          138, 19, 54, 10, 41, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
          115, 46, 99, 111, 109, 47, 103, 111, 111, 103, 108, 101, 46, 112, 114, 111, 116, 111, 98,
          117, 102, 46, 86, 97, 108, 117, 101, 18, 9, 17, 0, 0, 0, 0, 0, 0, 240, 63,
        ]))
      do {
        let redecoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(serializedData: protobuf)
        let json = try redecoded.jsonString()
  ...
  func test_Any_Value_string_JSON_roundtrip() throws {
    ...
    let start3 =
      "{\"optionalAny\":{\"@type\":\"type.googleapis.com/google.protobuf.Value\",\"value\":\"abc\"}}"
    do {
  ...
  func test_Any_Value_string_transcode() throws {
    ...
    do {
      ...
      XCTAssertEqual(
        protobuf,
        Data([
          138, 19, 50, 10, 41, 116, 121, 112, 101, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105,
          115, 46, 99, 111, 109, 47, 103, 111, 111, 103, 108, 101, 46, 112, 114, 111, 116, 111, 98,
          117, 102, 46, 86, 97, 108, 117, 101, 18, 5, 26, 3, 97, 98, 99,
        ]))
      do {
        let redecoded = try ProtobufTestMessages_Proto3_TestAllTypesProto3(serializedData: protobuf)
        let json = try redecoded.jsonString()
  ...
  func test_Any_JSON_Extensions() throws {
    ...
    XCTAssertEqual(
      json,
      "{\"anyValue\":{\"@type\":\"type.googleapis.com/protobuf_unittest.TestAllExtensions\",\"[protobuf_unittest.optional_int32_extension]\":17}}"
    )
    ...
    let decodedContent = try ProtobufUnittest_TestAllExtensions(
    ...
    let decodedWithExtensions = try ProtobufUnittest_TestAny(
      jsonString: json,
      extensions: ProtobufUnittest_Unittest_Extensions)
    // Still fails; the Any doesn't record extensions that were in effect when the outer Any was decoded
    XCTAssertThrowsError(
      try ProtobufUnittest_TestAllExtensions(unpackingAny: decodedWithExtensions.anyValue))
    let decodedWithExtensionsContent = try ProtobufUnittest_TestAllExtensions(
      unpackingAny: decodedWithExtensions.anyValue,
      extensions: ProtobufUnittest_Unittest_Extensions)
    XCTAssertEqual(content, decodedWithExtensionsContent)

    XCTAssertTrue(
      Google_Protobuf_Any.register(messageType: ProtobufUnittest_TestAllExtensions.self))
    ...
    for json in testcases {
      for ignoreUnknown in [false, true] {
        ...
        let decoded = try! ProtobufTestMessages_Proto3_TestAllTypesProto3(
          jsonString: json, options: options)
  ...
  func test_Any_Registry() {
    ...
    XCTAssertTrue(
      Google_Protobuf_Any.register(messageType: ProtobufUnittestImport_ImportMessage.self))
    XCTAssertTrue(
      Google_Protobuf_Any.register(messageType: ProtobufUnittestImport_ImportMessage.self))
    ...
    XCTAssertEqual(
      ConflictingImportMessage.protoMessageName,
      ProtobufUnittestImport_ImportMessage.protoMessageName)

    // Lookup
    XCTAssertTrue(
      Google_Protobuf_Any.messageType(
        forMessageName: ProtobufUnittestImport_ImportMessage.protoMessageName)
        == ProtobufUnittestImport_ImportMessage.self)
    XCTAssertNil(
      Google_Protobuf_Any.messageType(forMessageName: ProtobufUnittest_TestMap.protoMessageName))
    ...
    for t in wkts {
      XCTAssertTrue(
        Google_Protobuf_Any.messageType(forMessageName: t.protoMessageName) == t,
