...
class Test_Packed: XCTestCase, PBTestHelpers {
  ...
  func testEncoding_packedInt32() {
    assertEncode([
      210, 5, 16, 255, 255, 255, 255, 7, 0, 128, 128, 128, 128, 248, 255, 255, 255, 255, 1,
  ...
  func testEncoding_packedInt64() {
    assertEncode([
      218, 5, 20, 255, 255, 255, 255, 255, 255, 255, 255, 127, 0, 128, 128, 128, 128, 128, 128, 128,
      128, 128, 1,
    ]) { (o: inout MessageTestType) in o.packedInt64 = [Int64.max, 0, Int64.min] }
    assertDecodeSucceeds([
      218, 5, 18, 255, 255, 153, 166, 234, 175, 227, 1, 185, 156, 196, 237, 158, 222, 230, 255, 255,
      1,
    ]) { $0.packedInt64 == [999_999_999_999_999, -111_111_111_111_111] }
    assertDecodeSucceeds([
      218, 5, 18, 255, 255, 153, 166, 234, 175, 227, 1, 185, 156, 196, 237, 158, 222, 230, 255, 255,
      1, 218, 5, 18, 255, 255, 153, 166, 234, 175, 227, 1, 185, 156, 196, 237, 158, 222, 230, 255,
      255, 1,
    ]) {
      $0.packedInt64 == [
        999_999_999_999_999, -111_111_111_111_111, 999_999_999_999_999, -111_111_111_111_111,
      ]
    }
    assertDecodeSucceeds([218, 5, 0]) { $0.packedInt64 == [] }
    assertDecodeFails([
      218, 5, 19, 255, 255, 153, 166, 234, 175, 227, 1, 185, 156, 196, 237, 158, 222, 230, 255, 255,
      1,
    ])
    assertDecodeFails([
  ...
  func testEncoding_packedUint64() {
    assertEncode([234, 5, 11, 255, 255, 255, 255, 255, 255, 255, 255, 255, 1, 0]) {
      (o: inout MessageTestType) in o.packedUint64 = [UInt64.max, UInt64.min]
    }
  ...
  func testEncoding_packedSint32() {
    assertEncode([242, 5, 10, 254, 255, 255, 255, 15, 255, 255, 255, 255, 15]) {
      (o: inout MessageTestType) in o.packedSint32 = [Int32.max, Int32.min]
    }
    ...
    assertDecodeSucceeds([
      242, 5, 5, 255, 255, 255, 255, 15, 242, 5, 3, 1, 0, 2, 242, 5, 0, 242, 5, 5, 254, 255, 255,
      255, 15,
    ]) { $0.packedSint32 == [-2_147_483_648, -1, 0, 1, 2_147_483_647] }
    ...
    assertDecodeSucceeds([242, 5, 5, 255, 255, 255, 255, 127]) {
      $0.packedSint32 == [-2_147_483_648]
    }
  ...
  func testEncoding_packedSint64() {
    assertEncode([
      250, 5, 20, 254, 255, 255, 255, 255, 255, 255, 255, 255, 1, 255, 255, 255, 255, 255, 255, 255,
      255, 255, 1,
  ...
  func testEncoding_packedFixed64() {
    ...
    assertDecodeSucceeds([
      138, 6, 24, 255, 255, 255, 127, 0, 0, 0, 0, 255, 255, 255, 255, 0, 0, 0, 0, 255, 255, 255,
      255, 255, 255, 255, 255,
    ]) { $0.packedFixed64 == [2_147_483_647, 4_294_967_295, 18_446_744_073_709_551_615] }
    assertDecodeSucceeds([
      138, 6, 8, 255, 255, 255, 127, 0, 0, 0, 0, 138, 6, 16, 255, 255, 255, 255, 0, 0, 0, 0, 255,
    ...
    assertDecodeFails([
      138, 6, 23, 255, 255, 255, 127, 0, 0, 0, 0, 255, 255, 255, 255, 0, 0, 0, 0, 255, 255, 255,
      255, 255, 255, 255,
    ])
  ...
  func testEncoding_packedSfixed32() {
    ...
    assertDecodeSucceeds([
      146, 6, 4, 0, 0, 0, 128, 146, 6, 0, 146, 6, 8, 1, 0, 0, 0, 255, 255, 255, 127,
    ]) { $0.packedSfixed32 == [-2_147_483_648, 1, 2_147_483_647] }
    assertDecodeSucceeds([149, 6, 1, 0, 0, 0, 146, 6, 4, 7, 0, 0, 0]) {
      $0.packedSfixed32 == [1, 7]
    }
  ...
  func testEncoding_packedSfixed64() {
    ...
    assertDecodeSucceeds([
      154, 6, 32, 0, 0, 0, 0, 0, 0, 0, 128, 255, 255, 255, 127, 0, 0, 0, 0, 255, 255, 255, 255, 0,
      0, 0, 0, 255, 255, 255, 255, 255, 255, 255, 127,
    ]) {
      $0.packedSfixed64 == [
        -9_223_372_036_854_775_808, 2_147_483_647, 4_294_967_295, 9_223_372_036_854_775_807,
      ]
    }
    assertDecodeSucceeds([
      154, 6, 8, 0, 0, 0, 0, 0, 0, 0, 128, 154, 6, 0, 154, 6, 16, 255, 255, 255, 127, 0, 0, 0, 0,
      255, 255, 255, 255, 0, 0, 0, 0, 154, 6, 8, 255, 255, 255, 255, 255, 255, 255, 127,
    ]) {
      $0.packedSfixed64 == [
        -9_223_372_036_854_775_808, 2_147_483_647, 4_294_967_295, 9_223_372_036_854_775_807,
      ]
    ...
    assertDecodeFails([
      154, 6, 33, 0, 0, 0, 0, 0, 0, 0, 128, 255, 255, 255, 127, 0, 0, 0, 0, 255, 255, 255, 255, 0,
      0, 0, 0, 255, 255, 255, 255, 255, 255, 255, 127,
    ])
    assertDecodeFails([
      154, 6, 32, 0, 0, 0, 0, 0, 0, 0, 128, 255, 255, 255, 127, 0, 0, 0, 0, 255, 255, 255, 255, 0,
    ...
    assertDecodeFails([
      154, 6, 31, 0, 0, 0, 0, 0, 0, 0, 128, 255, 255, 255, 127, 0, 0, 0, 0, 255, 255, 255, 255, 0,
      0, 0, 0, 255, 255, 255, 255, 255, 255, 255,
    ])
  ...
  func testEncoding_packedFloat() {
    ...
    assertDecodeSucceeds([162, 6, 4, 0, 0, 0, 63, 162, 6, 4, 0, 0, 128, 62]) {
      $0.packedFloat == [0.5, 0.25]
    }
    assertDecodeSucceeds([165, 6, 0, 0, 0, 63, 162, 6, 4, 0, 0, 128, 62]) {
      $0.packedFloat == [0.5, 0.25]
    }
    assertDecodeSucceeds([162, 6, 4, 0, 0, 0, 63, 165, 6, 0, 0, 128, 62]) {
      $0.packedFloat == [0.5, 0.25]
    }
    assertDecodeSucceeds([165, 6, 0, 0, 0, 63, 165, 6, 0, 0, 128, 62]) {
      $0.packedFloat == [0.5, 0.25]
    }
  ...
  func testEncoding_packedDouble() {
    assertEncode([170, 6, 16, 0, 0, 0, 0, 0, 0, 224, 63, 0, 0, 0, 0, 0, 0, 208, 63]) {
      (o: inout MessageTestType) in o.packedDouble = [0.5, 0.25]
    }
    ...
    { $0.packedDouble == [0.5, 0.25] }
    assertDecodeSucceeds([
      170, 6, 8, 0, 0, 0, 0, 0, 0, 224, 63, 170, 6, 8, 0, 0, 0, 0, 0, 0, 208, 63,
    ]) { $0.packedDouble == [0.5, 0.25] }
  ...
  func testEncoding_packedBool() {
    assertEncode([178, 6, 4, 1, 0, 0, 1]) { (o: inout MessageTestType) in
      o.packedBool = [true, false, false, true]
    }
    assertDecodeSucceeds([178, 6, 4, 1, 0, 0, 1]) { $0.packedBool == [true, false, false, true] }
    assertDecodeSucceeds([178, 6, 5, 255, 1, 0, 0, 1]) {
      $0.packedBool == [true, false, false, true]
    }
    assertDecodeSucceeds([178, 6, 5, 1, 128, 0, 0, 1]) {
      $0.packedBool == [true, false, false, true]
    }
    assertDecodeSucceeds([
      178, 6, 14, 1, 128, 0, 0, 255, 255, 255, 255, 255, 255, 255, 255, 255, 127,
    ]) { $0.packedBool == [true, false, false, true] }
  ...
  func testEncoding_packedEnum() throws {
    assertEncode([186, 6, 2, 5, 4]) { (o: inout MessageTestType) in
      o.packedEnum = [.foreignBar, .foreignFoo]
    }
    ...
    assertDecodeSucceeds([186, 6, 2, 4, 6, 184, 6, 5]) {
      $0.packedEnum == [.foreignFoo, .foreignBaz, .foreignBar]
    }
    ...
    do {
      let decoded1 = try ProtobufUnittest_TestPackedTypes(
        serializedData: Data([186, 6, 3, 4, 99, 6]))
