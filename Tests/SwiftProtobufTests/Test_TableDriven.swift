// Tests/SwiftProtobufTests/Test_TableDriven.swift - Exercise table-driven protos
//
...
// -----------------------------------------------------------------------------
///
/// General tests for protos that target specific characteristics of the
/// table-driven implementation, like ensuring that copy-on-write semantics are
/// correct for the common message storage buffer.
///
// -----------------------------------------------------------------------------
