...
class Test_Map: XCTestCase, PBTestHelpers {
    ...
    func test_mapEnumUnknowns_Proto2() throws {
        ...
        let m2 = try ProtobufUnittest_TestEnumMap(contiguousBytes: Array(serialized))
        ...
        let m3 = try ProtobufUnittest_TestEnumMapPlusExtra(contiguousBytes: Array(serialized2))
    ...
    func test_mapEnumUnknowns_Proto3() throws {
        ...
        // It should be in unknowns
        let serialized = try m1.serializedData()
        let m2 = try ProtobufUnittest_TestMap(contiguousBytes: Array(serialized))
