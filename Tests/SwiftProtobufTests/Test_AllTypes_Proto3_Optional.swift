...
class Test_AllTypes_Proto3_Optional: XCTestCase, PBTestHelpers {
  ...
  func testEncoding_optionalInt32() {
    ...
    assertDebugDescription(
      "SwiftProtobufTests.ProtobufUnittest_TestProto3Optional:\noptional_int32: 0\n"
  ...
  func testEncoding_optionalFixed64() {
    ...
    assertDecodeSucceeds([65, 0, 0, 0, 0, 0, 0, 0, 0]) {
      $0.hasOptionalFixed64 && $0.optionalFixed64 == 0
    }
    assertDebugDescription(
      "SwiftProtobufTests.ProtobufUnittest_TestProto3Optional:\noptional_fixed64: 0\n"
  ...
  func testEncoding_optionalSfixed64() {
    assertEncode([81, 0, 0, 0, 0, 0, 0, 0, 0]) { (o: inout MessageTestType) in
      o.optionalSfixed64 = 0
    }
    assertDecodeSucceeds([81, 0, 0, 0, 0, 0, 0, 0, 0]) {
      $0.hasOptionalSfixed64 && $0.optionalSfixed64 == 0
    }
    assertDebugDescription(
      "SwiftProtobufTests.ProtobufUnittest_TestProto3Optional:\noptional_sfixed64: 0\n"
  ...
  func testEncoding_optionalDouble() {
    ...
    assertDecodeSucceeds([97, 0, 0, 0, 0, 0, 0, 0, 0]) {
      $0.hasOptionalDouble && $0.optionalDouble == 0.0
    }
    assertDebugDescription(
      "SwiftProtobufTests.ProtobufUnittest_TestProto3Optional:\noptional_double: 0.0\n"
    ) {
