...
class Test_JSON: XCTestCase, PBTestHelpers {
  ...
  func testOptionalUInt32() {
    ...
    assertJSONDecodeSucceeds("{\"optionalUint32\":4.294967295e9}") {
      $0.optionalUint32 == UInt32.max
    }
  ...
  func testOptionalInt64() throws {
    ...
    assertJSONDecodeSucceeds("{\"optionalInt64\":9223372036854775807}") {
      $0.optionalInt64 == Int64.max
    }
    assertJSONDecodeFails("{\"optionalInt64\":9223372036854775808}")
    assertJSONDecodeSucceeds("{\"optionalInt64\":-9223372036854775808}") {
      $0.optionalInt64 == Int64.min
    }
    ...
    assertJSONDecodeSucceeds("{\"optionalInt64\":-9.223372036854775808e18}") {
      $0.optionalInt64 == Int64.min
    }
  ...
  func testOptionalUInt64() {
    ...
    assertJSONEncode("{\"optionalUint64\":\"18446744073709551615\"}") {
      (o: inout MessageTestType) in
      o.optionalUint64 = UInt64.max
    }
    // Parse unquoted 64-bit integers
    assertJSONDecodeSucceeds("{\"optionalUint64\":18446744073709551615}") {
    ...
    assertJSONDecodeFails("{\"optionalUint64\":\"01\"}")
    // But it does accept exponential (as long as result is integral)
    assertJSONDecodeSucceeds("{\"optionalUint64\":4.294967295e9}") {
      $0.optionalUint64 == UInt64(UInt32.max)
    }
  ...
  func testOptionalDouble() throws {
    ...
    assertJSONDecodeSucceeds("{\"optionalDouble\":\"Inf\"}") {
      $0.optionalDouble == Double.infinity
    }
    assertJSONDecodeSucceeds("{\"optionalDouble\":\"-Inf\"}") {
      $0.optionalDouble == -Double.infinity
    }
  ...
  func testRepeatedNestedMessage() {
    ...
    assertJSONEncode("{\"repeatedNestedMessage\":[{\"bb\":1},{\"bb\":2}]}") {
      (o: inout MessageTestType) in
  ...
  func testRepeatedEnum() {
    ...
    assertJSONDecodeSucceeds("{\"repeatedNestedEnum\":[\"FOO\",0,1,\"BAR\",-1]}") {
...
class Test_JSONPacked: XCTestCase, PBTestHelpers {
  ...
  func testPackedInt32() {
    ...
    assertJSONDecodeSucceeds(" { \"packedInt32\" : [ \"1\" , \"2\" ] } ") {
      $0.packedInt32 == [1, 2]
    }
  }
  ...
  func testPackedSFixed32() {
    ...
    assertJSONEncode("{\"packedSfixed32\":[-2147483648,2147483647]}") {
      (o: inout MessageTestType) in
