...
class Test_AllTypes_Proto3: XCTestCase, PBTestHelpers {
  ...
  func testEncoding_optionalFixed64() throws {
    ...
    assertDecodeSucceeds([65, 255, 255, 255, 255, 255, 255, 255, 255]) { (o: MessageTestType) in
      ...
      return t == 18_446_744_073_709_551_615
    }
    assertDebugDescription("SwiftProtobufTests.Proto3Unittest_TestAllTypes:\noptional_fixed64: 1\n")
  ...
  func testEncoding_optionalSfixed64() throws {
    ...
    assertDecodeSucceeds([81, 0, 0, 0, 0, 0, 0, 0, 128]) { (o: MessageTestType) in
      ...
      return t == -9_223_372_036_854_775_808
    }
    assertDebugDescription(
      "SwiftProtobufTests.Proto3Unittest_TestAllTypes:\noptional_sfixed64: 1\n"
  ...
  func testEncoding_optionalNestedEnum() {
    ...
    assertDecodeSucceeds([168, 1, 255, 255, 255, 255, 255, 255, 255, 255, 255, 1]) {
      $0.optionalNestedEnum == .UNRECOGNIZED(-1)
    }
    assertDebugDescription(
  ...
  func testEncoding_repeatedInt32() {
    assertEncode([
      250, 1, 15, 255, 255, 255, 255, 7, 128, 128, 128, 128, 248, 255, 255, 255, 255, 1,
  ...
  func testEncoding_repeatedInt64() {
    assertEncode([
      130, 2, 19, 255, 255, 255, 255, 255, 255, 255, 255, 127, 128, 128, 128, 128, 128, 128, 128,
      128, 128, 1,
  ...
  func testEncoding_repeatedUint32() {
    assertEncode([138, 2, 6, 255, 255, 255, 255, 15, 0]) { (o: inout MessageTestType) in
  ...
  func testEncoding_repeatedUint64() {
    assertEncode([146, 2, 11, 255, 255, 255, 255, 255, 255, 255, 255, 255, 1, 0]) {
  ...
  func testEncoding_repeatedSint32() {
    assertEncode([154, 2, 10, 254, 255, 255, 255, 15, 255, 255, 255, 255, 15]) {
  ...
  func testEncoding_repeatedSint64() {
    assertEncode([
      162, 2, 20, 254, 255, 255, 255, 255, 255, 255, 255, 255, 1, 255, 255, 255, 255, 255, 255, 255,
      255, 255, 1,
  ...
  func testEncoding_repeatedFixed32() {
    assertEncode([170, 2, 8, 255, 255, 255, 255, 0, 0, 0, 0]) { (o: inout MessageTestType) in
  ...
  func testEncoding_repeatedFixed64() {
    assertEncode([178, 2, 16, 255, 255, 255, 255, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0, 0, 0]) {
  ...
  func testEncoding_repeatedSfixed32() {
    assertEncode([186, 2, 8, 255, 255, 255, 127, 0, 0, 0, 128]) { (o: inout MessageTestType) in
  ...
  func testEncoding_repeatedSfixed64() {
    assertEncode([194, 2, 16, 255, 255, 255, 255, 255, 255, 255, 127, 0, 0, 0, 0, 0, 0, 0, 128]) {
  ...
  func testEncoding_repeatedFloat() {
    assertEncode([202, 2, 8, 0, 0, 0, 63, 0, 0, 0, 0]) { (o: inout MessageTestType) in
  ...
  func testEncoding_repeatedDouble() {
    assertEncode([210, 2, 16, 0, 0, 0, 0, 0, 0, 224, 63, 0, 0, 0, 0, 0, 0, 0, 0]) {
  ...
  func testEncoding_repeatedBool() {
    assertEncode([218, 2, 3, 1, 0, 1]) { (o: inout MessageTestType) in
  ...
  func testEncoding_oneofUint32() {
    ...
    m.oneofUint32 = 77
    XCTAssertEqual(
      m.debugDescription, "SwiftProtobufTests.Proto3Unittest_TestAllTypes:\noneof_uint32: 77\n")
