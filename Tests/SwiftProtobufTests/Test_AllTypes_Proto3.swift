...
final class Test_AllTypes_Proto3: XCTestCase, PBTestHelpers {
    ...
    func testEncoding_repeatedInt32() {
        assertEncode([250, 1, 15, 255, 255, 255, 255, 7, 128, 128, 128, 128, 248, 255, 255, 255, 255, 1]) {
    ...
    func testEncoding_repeatedInt64() {
        assertEncode([
            130, 2, 19, 255, 255, 255, 255, 255, 255, 255, 255, 127, 128, 128, 128, 128, 128, 128, 128, 128, 128, 1,
    ...
    func testEncoding_repeatedUint64() {
        assertEncode([146, 2, 11, 255, 255, 255, 255, 255, 255, 255, 255, 255, 1, 0]) { (o: inout MessageTestType) in
            o.repeatedUint64 = [UInt64.max, UInt64.min]
        }
    ...
    func testEncoding_repeatedSint32() {
        assertEncode([154, 2, 10, 254, 255, 255, 255, 15, 255, 255, 255, 255, 15]) { (o: inout MessageTestType) in
    ...
    func testEncoding_repeatedSint64() {
        assertEncode([
            162, 2, 20, 254, 255, 255, 255, 255, 255, 255, 255, 255, 1, 255, 255, 255, 255, 255, 255, 255, 255, 255, 1,
    ...
    func testEncoding_repeatedDouble() {
        assertEncode([210, 2, 16, 0, 0, 0, 0, 0, 0, 224, 63, 0, 0, 0, 0, 0, 0, 0, 0]) { (o: inout MessageTestType) in
            o.repeatedDouble = [0.5, 0.0]
        }
    ...
    func testDebugDescription2() {
        ...
        assertDebugDescription("SwiftProtobufTests.SwiftProtoTesting_ForeignMessage:\n", m)
        m.c = 3
        assertDebugDescription("SwiftProtobufTests.SwiftProtoTesting_ForeignMessage:\nc: 3\n", m)
    }
    ...
    func testDebugDescription3() {
        ...
        var m = SwiftProtoTesting_TestOneof()
        assertDebugDescription("SwiftProtobufTests.SwiftProtoTesting_TestOneof:\n", m)
        m.fooInt = 1
        assertDebugDescription("SwiftProtobufTests.SwiftProtoTesting_TestOneof:\nfoo_int: 1\n", m)
        m.fooString = "a"
        assertDebugDescription("SwiftProtobufTests.SwiftProtoTesting_TestOneof:\nfoo_string: \"a\"\n", m)
        var g = SwiftProtoTesting_TestOneof.FooGroup()
        g.a = 7
        g.b = "b"
        m.fooGroup = g
        assertDebugDescription(
            "SwiftProtobufTests.SwiftProtoTesting_TestOneof:\nFooGroup {\n  a: 7\n  b: \"b\"\n}\n",
            m
        )
    }
}
