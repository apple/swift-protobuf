...
class Test_TextFormat_Map_proto3: XCTestCase, PBTestHelpers {
  ...
  func test_Int32Int32() {
    ...
    assertTextFormatDecodeSucceeds("map_int32_int32 [{key:1 value:2}, {key:3 value:4}]") {
      (o: MessageTestType) in
      return o.mapInt32Int32 == [1: 2, 3: 4]
    }
    assertTextFormatDecodeSucceeds(
      "map_int32_int32 [{key:1 value:2}];map_int32_int32 {key:3 value:4}"
    ) { (o: MessageTestType) in
      return o.mapInt32Int32 == [1: 2, 3: 4]
    }
  ...
  func test_Int32Int32_numbers() {
    ...
    assertTextFormatDecodeSucceeds("1 [{key:1 value:2}];1 {key:3 value:4}") {
      (o: MessageTestType) in
      return o.mapInt32Int32 == [1: 2, 3: 4]
    }
