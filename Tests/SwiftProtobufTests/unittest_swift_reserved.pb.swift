...
struct ProtobufUnittest_SwiftReservedTest {
  ...
  struct classMessage: SwiftProtobufCore.ExtensibleMessage {
    // SwiftProtobufCore.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  struct TypeMessage: SwiftProtobufCore.ExtensibleMessage {
    // SwiftProtobufCore.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
let ProtobufUnittest_UnittestSwiftReserved_Extensions: SwiftProtobufCore.SimpleExtensionMap = [
...
/// Won't get _p added because it is fully qualified.
let ProtobufUnittest_Extensions_debug_description = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
...
/// These are scoped to the file, so the package prefix (or a Swift prefix)
/// will get added to them to they aren't going to get renamed.
let ProtobufUnittest_Extensions_as = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1012,
  fieldName: "protobuf_unittest.as"
)

let ProtobufUnittest_Extensions_var = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1013,
  fieldName: "protobuf_unittest.var"
)

let ProtobufUnittest_Extensions_try = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1014,
  fieldName: "protobuf_unittest.try"
)

let ProtobufUnittest_Extensions_do = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1015,
  fieldName: "protobuf_unittest.do"
)

let ProtobufUnittest_Extensions_nil = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
...
extension ProtobufUnittest_SwiftReservedTestExt {
  enum Extensions {
    ...
    /// the raw form is used ("hash_value", not the Swift one "hashValue"),
    /// so there is no conflict, and no renaming happens.
    static let hash_value = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
    ...
    /// Reserved words, since these end up in the "struct Extensions", they
    /// can't just be get their names, and sanitation kicks.
    static let `as` = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1022,
      fieldName: "protobuf_unittest.SwiftReservedTestExt.as"
    )

    static let `var` = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1023,
      fieldName: "protobuf_unittest.SwiftReservedTestExt.var"
    )

    static let `try` = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1024,
      fieldName: "protobuf_unittest.SwiftReservedTestExt.try"
    )

    static let `do` = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1025,
      fieldName: "protobuf_unittest.SwiftReservedTestExt.do"
    )

    static let `nil` = SwiftProtobufCore.MessageExtension<SwiftProtobufCore.OptionalExtensionField<SwiftProtobufCore.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
...
extension ProtobufUnittest_SwiftReservedTest: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
...
extension ProtobufUnittest_SwiftReservedTest.Enum: SwiftProtobufCore._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobufCore._NameMap = [
    1: .same(proto: "DOUBLE"),
    2: .same(proto: "JSON"),
    3: .same(proto: "CLASS"),
...
extension ProtobufUnittest_SwiftReservedTest.ProtocolEnum: SwiftProtobufCore._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobufCore._NameMap = [
    1: .same(proto: "a"),
  ]
}

extension ProtobufUnittest_SwiftReservedTest.classMessage: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
...
extension ProtobufUnittest_SwiftReservedTest.TypeMessage: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
...
extension ProtobufUnittest_SwiftReservedTest.isEqual: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
...
extension ProtobufUnittest_SwiftReservedTestExt: SwiftProtobufCore.Message, SwiftProtobufCore._MessageImplementationBase, SwiftProtobufCore._ProtoNameProviding {
