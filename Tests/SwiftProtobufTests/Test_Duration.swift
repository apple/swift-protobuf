...
class Test_Duration: XCTestCase, PBTestHelpers {
    ...
    func testConformance() throws {
        let tooSmall = try ProtobufTestMessages_Proto3_TestAllTypesProto3(serializedBytes: [234, 18, 11, 8, 255, 195, 209, 177, 232, 246, 255, 255, 255, 1])
        ...
        let tooBig = try ProtobufTestMessages_Proto3_TestAllTypesProto3(serializedBytes: [234, 18, 7, 8, 129, 188, 174, 206, 151, 9])
