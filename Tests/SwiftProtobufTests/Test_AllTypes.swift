...
class Test_AllTypes: XCTestCase, PBTestHelpers {
  ...
  func assertDecodeSucceeds(
    _ bytes: [UInt8], file: XCTestFileArgType = #file, line: UInt = #line,
  ...
  func assertDebugDescription(
    _ expected: String, file: XCTestFileArgType = #file, line: UInt = #line,
  ...
  func testEncoding_optionalInt32() {
    ...
    assertEncode([8, 255, 255, 255, 255, 7]) { (o: inout MessageTestType) in
      o.optionalInt32 = Int32.max
    }
    assertEncode([8, 128, 128, 128, 128, 248, 255, 255, 255, 255, 1]) {
      (o: inout MessageTestType) in o.optionalInt32 = Int32.min
    }
  ...
  func testEncoding_optionalInt64() {
    ...
    assertEncode([16, 128, 128, 128, 128, 128, 128, 128, 128, 128, 1]) {
      (o: inout MessageTestType) in o.optionalInt64 = Int64.min
    }
  ...
  func testEncoding_optionalUint32() {
    assertEncode([24, 255, 255, 255, 255, 15]) { (o: inout MessageTestType) in
      o.optionalUint32 = UInt32.max
    }
  ...
  func testEncoding_optionalUint64() {
    assertEncode([32, 255, 255, 255, 255, 255, 255, 255, 255, 255, 1]) {
      (o: inout MessageTestType) in o.optionalUint64 = UInt64.max
    }
  ...
  func testEncoding_optionalSint32() {
    assertEncode([40, 254, 255, 255, 255, 15]) { (o: inout MessageTestType) in
      o.optionalSint32 = Int32.max
    }
    assertEncode([40, 255, 255, 255, 255, 15]) { (o: inout MessageTestType) in
      o.optionalSint32 = Int32.min
    }
    ...
    assertDecodeSucceeds([40, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f]) {
      $0.optionalSint32 == -2_147_483_648
    }
    assertDecodeSucceeds([40, 0xfe, 0xff, 0xff, 0xff, 0xff, 0x7f]) {
      $0.optionalSint32 == 2_147_483_647
    }
  ...
  func testEncoding_optionalSint64() {
    assertEncode([48, 254, 255, 255, 255, 255, 255, 255, 255, 255, 1]) {
      (o: inout MessageTestType) in o.optionalSint64 = Int64.max
    }
    assertEncode([48, 255, 255, 255, 255, 255, 255, 255, 255, 255, 1]) {
      (o: inout MessageTestType) in o.optionalSint64 = Int64.min
    }
  ...
  func testEncoding_optionalFixed32() {
    assertEncode([61, 255, 255, 255, 255]) { (o: inout MessageTestType) in
      o.optionalFixed32 = UInt32.max
    }
  ...
  func testEncoding_optionalFixed64() {
    ...
    assertEncode([65, 0, 0, 0, 0, 0, 0, 0, 0]) { (o: inout MessageTestType) in
      o.optionalFixed64 = UInt64.min
    }
  ...
  func testEncoding_optionalSfixed32() {
    assertEncode([77, 255, 255, 255, 127]) { (o: inout MessageTestType) in
      o.optionalSfixed32 = Int32.max
    }
  ...
  func testEncoding_optionalSfixed64() {
    ...
    assertEncode([81, 0, 0, 0, 0, 0, 0, 0, 128]) { (o: inout MessageTestType) in
      o.optionalSfixed64 = Int64.min
    }
    assertDecodeSucceeds([81, 0, 0, 0, 0, 0, 0, 0, 128]) {
      $0.optionalSfixed64 == -9_223_372_036_854_775_808
    }
    assertDebugDescription(
      "SwiftProtobufTests.ProtobufUnittest_TestAllTypes:\noptional_sfixed64: 1\n"
  ...
  func testEncoding_optionalDouble() {
    assertEncode([97, 0, 0, 0, 0, 0, 0, 0, 0]) { (o: inout MessageTestType) in
      o.optionalDouble = 0.0
    }
    assertEncode([97, 0, 0, 0, 0, 0, 0, 224, 63]) { (o: inout MessageTestType) in
      o.optionalDouble = 0.5
    }
    assertEncode([97, 0, 0, 0, 0, 0, 0, 0, 64]) { (o: inout MessageTestType) in
      o.optionalDouble = 2.0
    }
  ...
  func testEncoding_optionalString() {
    ...
    assertEncode([114, 4, 0xf0, 0x9f, 0x98, 0x84]) { (o: inout MessageTestType) in
      o.optionalString = "😄"
    }
  ...
  func testEncoding_optionalNestedEnum() throws {
    ...
    assertDecodeSucceeds([168, 1, 255, 255, 255, 255, 255, 255, 255, 255, 255, 1]) {
  ...
  func testEncoding_repeatedInt32() {
    assertEncode([
      248, 1, 255, 255, 255, 255, 7, 248, 1, 128, 128, 128, 128, 248, 255, 255, 255, 255, 1,
    ]) { (o: inout MessageTestType) in o.repeatedInt32 = [Int32.max, Int32.min] }
    assertDecodeSucceeds([248, 1, 8, 248, 1, 247, 255, 255, 255, 15]) {
      $0.repeatedInt32 == [8, -9]
    }
  ...
  func testEncoding_repeatedInt64() {
    assertEncode([
      128, 2, 255, 255, 255, 255, 255, 255, 255, 255, 127, 128, 2, 128, 128, 128, 128, 128, 128,
      128, 128, 128, 1,
    ]) { (o: inout MessageTestType) in o.repeatedInt64 = [Int64.max, Int64.min] }
    assertDecodeSucceeds([
      128, 2, 255, 255, 153, 166, 234, 175, 227, 1, 128, 2, 185, 156, 196, 237, 158, 222, 230, 255,
      255, 1,
  ...
  func testEncoding_repeatedUint32() {
    ...
    assertDecodeSucceeds([136, 2, 255, 255, 255, 255, 15, 136, 2, 213, 27]) {
  ...
  func testEncoding_repeatedSint32() {
    assertEncode([152, 2, 254, 255, 255, 255, 15, 152, 2, 255, 255, 255, 255, 15]) {
      (o: inout MessageTestType) in o.repeatedSint32 = [Int32.max, Int32.min]
    }
    ...
    assertDecodeFails([
      152, 2, 170, 180, 222, 117, 152, 2, 225, 162, 243, 173, 255, 255, 255, 255, 255, 255, 1,
    ])
  ...
  func testEncoding_repeatedSint64() {
    assertEncode([
      160, 2, 254, 255, 255, 255, 255, 255, 255, 255, 255, 1, 160, 2, 255, 255, 255, 255, 255, 255,
      255, 255, 255, 1,
    ...
    assertDecodeFails([
      160, 2, 170, 180, 222, 117, 160, 2, 225, 162, 243, 173, 255, 255, 255, 255, 255, 255, 1,
    ])
  ...
  func testEncoding_repeatedFixed64() {
    ...
    assertDecodeSucceeds([
      177, 2, 255, 255, 255, 127, 0, 0, 0, 0, 177, 2, 255, 255, 255, 255, 0, 0, 0, 0, 177, 2, 255,
  ...
  func testEncoding_repeatedSfixed32() {
    ...
    assertDecodeSucceeds([186, 2, 4, 1, 0, 0, 0, 189, 2, 3, 0, 0, 0]) {
      $0.repeatedSfixed32 == [1, 3]
    }
  ...
  func testEncoding_repeatedSfixed64() {
    ...
    assertDecodeSucceeds([
      193, 2, 0, 0, 0, 0, 0, 0, 0, 128, 193, 2, 255, 255, 255, 255, 255, 255, 255, 255, 193, 2, 1,
      0, 0, 0, 0, 0, 0, 0, 193, 2, 255, 255, 255, 255, 255, 255, 255, 127,
  ...
  func testEncoding_repeatedFloat() {
    ...
    assertDecodeSucceeds([205, 2, 0, 0, 0, 63, 205, 2, 0, 0, 0, 63]) {
      $0.repeatedFloat == [0.5, 0.5]
    }
  ...
  func testEncoding_repeatedBool() {
    ...
    assertDecodeSucceeds([218, 2, 3, 1, 0, 1, 216, 2, 0]) {
      $0.repeatedBool == [true, false, true, false]
    }
  ...
  func testEncoding_repeatedString() {
    assertEncode([226, 2, 1, 65, 226, 2, 1, 66]) { (o: inout MessageTestType) in
      o.repeatedString = ["A", "B"]
    }
    assertDecodeSucceeds([
      226, 2, 5, 72, 101, 108, 108, 111, 226, 2, 5, 119, 111, 114, 108, 100, 226, 2, 0,
  ...
  func testEncoding_repeatedNestedMessage_unknown() {
    ...
    do {
      ...
      XCTAssertNotEqual(
        m.repeatedNestedMessage[0], MessageTestType.NestedMessage.with { $0.bb = 1 })
      XCTAssertEqual(m.repeatedNestedMessage[0].bb, 1)
      XCTAssertNotEqual(
        m.repeatedNestedMessage[1], MessageTestType.NestedMessage.with { $0.bb = 2 })
  ...
  func testEncoding_repeatedNestedEnum() throws {
    ...
    // The out-of-range enum value should be preserved as an unknown field
    do {
      let decoded1 = try ProtobufUnittest_TestAllTypes(
        serializedData: Data([152, 3, 1, 152, 3, 128, 1]))
    ...
    do {
      let decoded2 = try ProtobufUnittest_TestAllTypes(
        serializedData: Data([152, 3, 128, 1, 152, 3, 2]))
    ...
    do {
      let decoded3 = try ProtobufUnittest_TestAllTypes(
        serializedData: Data([154, 3, 3, 128, 1, 2]))
  ...
  func testEncoding_defaultSfixed64() throws {
    ...
    assertDecodeSucceeds([177, 4, 206, 255, 255, 255, 255, 255, 255, 255]) {
      $0.defaultSfixed64 == -50
    }
  ...
  func testEncoding_defaultBool() throws {
    ...
    assertJSONEncode("{\"defaultBool\":false}") { (o: inout MessageTestType) in
      o.defaultBool = false
    }
  ...
  func testEncoding_defaultForeignEnum() throws {
    ...
    assertDecodeSucceeds([144, 5, 6]) {
      $0.defaultForeignEnum == ProtobufUnittest_ForeignEnum.foreignBaz
    }
  }
  ...
  func testEncoding_oneofUint32() throws {
    ...
    m.oneofUint32 = 77
    XCTAssertEqual(
      m.debugDescription, "SwiftProtobufTests.ProtobufUnittest_TestAllTypes:\noneof_uint32: 77\n")
  ...
  func testDebugDescription2() {
    ...
    m.c = 3
    XCTAssertEqual(
      "SwiftProtobufTests.ProtobufUnittest_ForeignMessage:\nc: 3\n", m.debugDescription)
  }
  ...
  func testDebugDescription3() {
    ...
    m.fooInt = 1
    XCTAssertEqual(
      "SwiftProtobufTests.ProtobufUnittest_TestOneof:\nfoo_int: 1\n", m.debugDescription)
    m.fooString = "a"
    XCTAssertEqual(
      "SwiftProtobufTests.ProtobufUnittest_TestOneof:\nfoo_string: \"a\"\n", m.debugDescription)
  ...
  func testWithFactoryHelperRethrows() {
    ...
    let pNoThrow: (inout ProtobufUnittest_ForeignMessage) -> Void = { $0.c = 1 }
    let m1 = ProtobufUnittest_ForeignMessage.with(pNoThrow)
    XCTAssertEqual(1, m1.c)

    var populatorRan = false
    let pThrow: (inout ProtobufUnittest_ForeignMessage) throws -> Void = {
      $0.c = 2
      populatorRan = true
