...
class Test_Required: XCTestCase, PBTestHelpers {
    ...
    func test_decodeRequired() throws {
        ...
        let fullMsg = try ProtobufUnittest_TestAllRequiredTypes(contiguousBytes: allBytes)
...
class Test_SmallRequired: XCTestCase, PBTestHelpers {
    ...
    func test_decodeRequired() throws {
        ...
        let fullMsg = try ProtobufUnittest_TestSomeRequiredTypes(contiguousBytes: allBytes)
        assertDebugDescription(allTextFormattedField, fullMsg)
    }
