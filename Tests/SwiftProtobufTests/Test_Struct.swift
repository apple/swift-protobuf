...
class Test_Struct: XCTestCase, PBTestHelpers {
  ...
  func testStruct_pbencode() {
    assertEncode([10, 12, 10, 3, 102, 111, 111, 18, 5, 26, 3, 98, 97, 114]) {
  ...
  func test_JSON_field() throws {
    ...
    do {
      let c1 = try ProtobufTestMessages_Proto3_TestAllTypesProto3(
        jsonString: "{\"optionalStruct\":null}")
    ...
    do {
      let c2 = try ProtobufTestMessages_Proto3_TestAllTypesProto3(
        jsonString: "{\"optionalStruct\":{}}")
...
class Test_JSON_Value: XCTestCase, PBTestHelpers {
  ...
  func testValue_null() throws {
    ...
    do {
      let m1 = try ProtobufTestMessages_Proto3_TestAllTypesProto3(
        jsonString: "{\"optionalValue\": null}")
    ...
    XCTAssertEqual(
      null.debugDescription, "SwiftProtobuf.Google_Protobuf_Value:\nnull_value: NULL_VALUE\n")
  }
  ...
  func testValue_number() throws {
    ...
    XCTAssertEqual(
      oneFromIntegerLiteral.debugDescription,
      "SwiftProtobuf.Google_Protobuf_Value:\nnumber_value: 1.0\n")
  }
  ...
  func testValue_string() throws {
    ...
    let valueWithEscapes = Google_Protobuf_Value(
      stringValue: "a\u{0008}\u{0009}\u{000a}\u{000c}\u{000d}b")
    ...
    // PB serialization
    XCTAssertEqual(
      [26, 3, 97, 34, 98], try Google_Protobuf_Value(stringValue: "a\"b").serializedBytes())

    XCTAssertEqual(
      fromStringLiteral.debugDescription,
      "SwiftProtobuf.Google_Protobuf_Value:\nstring_value: \"abcd\"\n")
  }
  ...
  func testValue_bool() {
    ...
    XCTAssertEqual(
      trueFromLiteral.debugDescription, "SwiftProtobuf.Google_Protobuf_Value:\nbool_value: true\n")
  }
