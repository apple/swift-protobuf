...
class Test_Map_JSON: XCTestCase, PBTestHelpers {
  ...
  func testMapInt32Int32() throws {
    ...
    assertJSONDecodeSucceeds("{\"mapInt32Int32\":{\"3\":4,\"1\":2}}") {
      $0.mapInt32Int32 == [1: 2, 3: 4]
    }
  ...
  func testMapUInt64UInt64() throws {
    ...
    assertJSONEncode("{\"mapUint64Uint64\":{\"1\":\"18446744073709551615\"}}") {
      (o: inout MessageTestType) in
  ...
  func testFixed64Fixed64() throws {
    ...
    assertJSONEncode("{\"mapFixed64Fixed64\":{\"1\":\"18446744073709551615\"}}") {
      (o: inout MessageTestType) in
  ...
  func testSFixed64SFixed64() throws {
    ...
    assertJSONDecodeSucceeds(
      "{\"mapSfixed64Sfixed64\":{\"9223372036854775807\":-9223372036854775808}}"
    ) {
  ...
  func testMapInt32Message() {
    assertJSONEncode("{\"mapInt32ForeignMessage\":{\"7\":{\"c\":999}}}") {
      (o: inout MessageTestType) in
