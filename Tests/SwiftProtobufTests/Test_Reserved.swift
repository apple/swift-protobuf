...
class Test_Reserved: XCTestCase {
  func testEnumNaming() {
    ...
    XCTAssertEqual(
      String(describing: ProtobufUnittest_SwiftReservedTest.Enum.double.name!), "DOUBLE")
    ...
    XCTAssertEqual(
      String(describing: ProtobufUnittest_SwiftReservedTest.Enum.`class`.name!), "CLASS")
  ...
  func testMessageNames() {
    XCTAssertEqual(
      ProtobufUnittest_SwiftReservedTest.classMessage.protoMessageName,
      "protobuf_unittest.SwiftReservedTest.class")
    XCTAssertEqual(
      ProtobufUnittest_SwiftReservedTest.isEqual.protoMessageName,
      "protobuf_unittest.SwiftReservedTest.isEqual")
    XCTAssertEqual(
      ProtobufUnittest_SwiftReservedTest.TypeMessage.protoMessageName,
      "protobuf_unittest.SwiftReservedTest.Type")
  }
  ...
  func testFieldNamesMatchingMetadata() {
    ...
    XCTAssertEqual(
      ...
      "SwiftProtobufTests.ProtobufUnittest_SwiftReservedTest:\nproto_message_name: 1\nproto_package_name: 2\nany_type_prefix: 3\nany_type_url: 4\nis_initialized: \"foo\"\nhash_value: \"bar\"\ndebug_description: 5\n"
    )
