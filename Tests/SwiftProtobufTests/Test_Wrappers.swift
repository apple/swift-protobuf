...
final class Test_Wrappers: XCTestCase {
    ...
    func testDoubleValue() throws {
        ...
        XCTAssertEqual(m, try Google_Protobuf_DoubleValue(contiguousBytes: [9,0,0,0,0,0,0,240,63]))
    ...
    func testFloatValue() throws {
        ...
        XCTAssertEqual(m, try Google_Protobuf_FloatValue(contiguousBytes: [13,0,0,128,63]))
