...
final class Test_MessageSet: XCTestCase {
    ...
    func testParse() throws {
        ...
        XCTAssertEqual(
            msg.SwiftProtoTesting_TestMessageSetExtension2_messageSetExtension.str,
            "foo"
        )
        XCTAssertTrue(
    ...
    func testTextFormat_Parse() {
        ...
        XCTAssertEqual(
            msg.messageSet.SwiftProtoTesting_TestMessageSetExtension1_messageSetExtension.i,
            23
        )
        XCTAssertEqual(
            msg.messageSet.SwiftProtoTesting_TestMessageSetExtension2_messageSetExtension.str,
            "foo"
        )
