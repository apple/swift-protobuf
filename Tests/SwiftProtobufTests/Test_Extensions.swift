...
class Test_Extensions: XCTestCase, PBTestHelpers {
    ...
    func test_optionalInt32Extension() throws {
        ...
        let m1 = try ProtobufUnittest_TestAllExtensions(contiguousBytes: [8, 17], extensions: extensions)
    ...
    func test_extensionMessageSpecificity() throws {
        ...
        let m1 = try ProtobufUnittest_TestAllExtensions(contiguousBytes: [40, 1], extensions: extensions)
        XCTAssertEqual(m1.ProtobufUnittest_optionalSint32Extension, -1)

        // This should decode with myExtensionInt
        let m2 = try ProtobufUnittest_TestFieldOrderings(contiguousBytes: [40, 1], extensions: extensions)
