...
final class Test_GroupWithinGroup: XCTestCase, PBTestHelpers {
    ...
    func testGroupWithGroup_Single() {
        ...
        assertDecodeSucceeds([19, 19, 20, 20]) {
            $0.subGroup1.hasSubGroup2 && $0.subGroup1.subGroup2 == MessageTestType.SubGroup1.SubGroup2()
        }
    ...
    func testGroupWithGroup_Repeated() {
        ...
        assertDecodeSucceeds([27, 19, 8, 1, 20, 28]) {
            $0.subGroup3.count == 1 && $0.subGroup3[0].subGroup4.count == 1 && $0.subGroup3[0].subGroup4[0].sub4A == 1
        }
        // Empty group
        assertDecodeSucceeds([27, 19, 20, 28]) { (o: MessageTestType) -> Bool in
            o.subGroup3.count == 1 && o.subGroup3[0].subGroup4.count == 1
