// Tests/ExperimentalTableDrivenSwiftProtobufTests/Test_TextFormat.swift - Exercise text format coding
//
...
final class Test_TextFormat_proto3: XCTestCase, PBTestHelpers {
    ...
    func testEncoding_optionalInt64() {
        ...
        assertTextFormatDecodeSucceeds("optional_int64: 0x1234567812345678\n") { (o: MessageTestType) in
            o.optionalInt64 == 0x1234_5678_1234_5678
        }
    ...
    func testEncoding_optionalUint32() {
        ...
        assertTextFormatDecodeSucceeds("optional_uint32: 03 optional_int32: 1") {
            (o: MessageTestType) in
            o.optionalUint32 == 3 && o.optionalInt32 == 1
        }
    ...
    func testEncoding_optionalUint64() {
        ...
        assertTextFormatDecodeSucceeds("optional_uint64: 0xf234567812345678\n") { (o: MessageTestType) in
            o.optionalUint64 == 0xf234_5678_1234_5678
        }
    ...
    func testEncoding_optionalFloat() {
        ...
        assertTextFormatDecodeSucceeds("optional_float: 1e-50\n") {
            (o: MessageTestType) in
            o.optionalFloat == 0.0 && o.optionalFloat.sign == .plus
        }
        assertTextFormatDecodeSucceeds("optional_float: -1e-50\n") {
            (o: MessageTestType) in
            o.optionalFloat == 0.0 && o.optionalFloat.sign == .minus
        }
        // protobuf conformance requires subnormals to be handled
        assertTextFormatDecodeSucceeds("optional_float: 1.17549e-39\n") {
            (o: MessageTestType) in
            o.optionalFloat == Float(1.17549e-39)
        }
        assertTextFormatDecodeSucceeds("optional_float: -1.17549e-39\n") {
            (o: MessageTestType) in
            o.optionalFloat == Float(-1.17549e-39)
        ...
        assertTextFormatDecodeSucceeds("optional_float: 18446744073709551616\n") {
            (o: MessageTestType) in
            o.optionalFloat == 1.84467441e+19
        }
        assertTextFormatDecodeSucceeds("optional_float: -18446744073709551616\n") {
            (o: MessageTestType) in
            o.optionalFloat == -1.84467441e+19
        ...
        let b = SwiftProtoTesting_TestAllTypes.with { $0.optionalFloat = Float.nan }
        XCTAssertEqual("optional_float: nan\n", b.textFormatString())

        do {
            let nan1 = try SwiftProtoTesting_TestAllTypes(textFormatString: "optional_float: nan\n")
        ...
        do {
            let nan2 = try SwiftProtoTesting_TestAllTypes(textFormatString: "optional_float: NaN\n")
    ...
    func testEncoding_optionalDouble() {
        ...
        let b = SwiftProtoTesting_TestAllTypes.with { $0.optionalDouble = Double.nan }
        ...
        assertTextFormatDecodeSucceeds("optional_double: 1e-9999\n") {
            (o: MessageTestType) in
            o.optionalDouble == 0.0 && o.optionalDouble.sign == .plus
        }
        assertTextFormatDecodeSucceeds("optional_double: -1e-9999\n") {
            (o: MessageTestType) in
            o.optionalDouble == 0.0 && o.optionalDouble.sign == .minus
        }
    ...
    func testEncoding_optionalBool() {
        ...
        XCTAssertEqual("optional_bool: false\n", a.textFormatString())
    ...
    func testEncoding_optionalBytes() throws {
        let o = SwiftProtoTesting_TestAllTypes.with { $0.optionalBytes = Data() }
        XCTAssertEqual("optional_bytes: \"\"\n", o.textFormatString())
    ...
    func testEncoding_optionalBytes_roundtrip() throws {
        for i in UInt8(0)...UInt8(255) {
            ...
            let decoded = try SwiftProtoTesting_TestAllTypes(textFormatString: text)
    ...
    func testEncoding_repeatedInt32() {
        ...
        assertTextFormatEncode("repeated_int32: 1\nrepeated_int32: 2\n") { (o: inout MessageTestType) in
            o.repeatedInt32 = [1, 2]
        }
    ...
    func testEncoding_repeatedInt64() {
        assertTextFormatEncode("repeated_int64: 3\nrepeated_int64: 4\n") { (o: inout MessageTestType) in
            o.repeatedInt64 = [3, 4]
        }
    ...
    func testEncoding_repeatedUint32() {
        assertTextFormatEncode("repeated_uint32: 5\nrepeated_uint32: 6\n") { (o: inout MessageTestType) in
    ...
    func testEncoding_repeatedUint64() {
        assertTextFormatEncode("repeated_uint64: 7\nrepeated_uint64: 8\n") { (o: inout MessageTestType) in
    ...
    func testEncoding_repeatedSint32() {
        assertTextFormatEncode("repeated_sint32: 9\nrepeated_sint32: 10\n") { (o: inout MessageTestType) in
    ...
    func testEncoding_repeatedSint64() {
        assertTextFormatEncode("repeated_sint64: 11\nrepeated_sint64: 12\n") { (o: inout MessageTestType) in
    ...
    func testEncoding_repeatedFixed32() {
        assertTextFormatEncode("repeated_fixed32: 13\nrepeated_fixed32: 14\n") { (o: inout MessageTestType) in
    ...
    func testEncoding_repeatedFixed64() {
        assertTextFormatEncode("repeated_fixed64: 15\nrepeated_fixed64: 16\n") { (o: inout MessageTestType) in
    ...
    func testEncoding_repeatedSfixed32() {
        assertTextFormatEncode("repeated_sfixed32: 17\nrepeated_sfixed32: 18\n") { (o: inout MessageTestType) in
    ...
    func testEncoding_repeatedSfixed64() {
        assertTextFormatEncode("repeated_sfixed64: 19\nrepeated_sfixed64: 20\n") { (o: inout MessageTestType) in
    ...
    func testEncoding_repeatedFloat() {
        assertTextFormatEncode("repeated_float: 21.0\nrepeated_float: 22.0\n") { (o: inout MessageTestType) in
    ...
    func testEncoding_repeatedDouble() {
        assertTextFormatEncode("repeated_double: 23.0\nrepeated_double: 24.0\n") { (o: inout MessageTestType) in
            o.repeatedDouble = [23, 24]
        }
        assertTextFormatEncode("repeated_double: 2.25\nrepeated_double: 2.5\n") { (o: inout MessageTestType) in
    ...
    func testEncoding_repeatedBool() {
        assertTextFormatEncode("repeated_bool: true\nrepeated_bool: false\n") { (o: inout MessageTestType) in
            o.repeatedBool = [true, false]
        }
        assertTextFormatDecodeSucceeds("repeated_bool: [true, false, True, False, t, f, 1, 0]") {
            (o: MessageTestType) in
            o.repeatedBool == [true, false, true, false, true, false, true, false]
        }
    ...
    func testEncoding_repeatedForeignMessage() {
        ...
        do {
            let message = try MessageTestType(
                textFormatString: "repeated_foreign_message: {\n  c: 88\n}\nrepeated_foreign_message: {\n  c: -88\n}\n"
            )
    ...
    func testEncoding_repeatedImportMessage() {
        ...
        do {
            let message = try MessageTestType(
                textFormatString: "repeated_import_message: {\n  d: -9\n}\nrepeated_import_message: {\n  d: 999999\n}\n"
            )
    ...
    func testEncoding_repeatedNestedEnum() throws {
        ...
        assertTextFormatDecodeSucceeds(
            "repeated_nested_enum: [] repeated_nested_enum: [2] repeated_nested_enum: [BAZ] repeated_nested_enum: []"
        ) {
            (o: MessageTestType) in
            o.repeatedNestedEnum == [.bar, .baz]
        }
    ...
    func testExplicitDelimiters() {
        assertTextFormatDecodeSucceeds("optional_int32:1,optional_int64:3;optional_uint32:4") { (o: MessageTestType) in
            o.optionalInt32 == 1 && o.optionalInt64 == 3 && o.optionalUint32 == 4
        }
