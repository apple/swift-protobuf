...
extension SwiftFeatureTest_TestFeatures: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{1}feature1\u{0}\u{1}\u{2}feature2\u{0}\u{1}\u{3}feature3\u{0}\u{1}\u{4}feature4\u{0}\u{1}\u{5}feature5\u{0}"
...
extension SwiftFeatureTest_TestFeatures.EnumFeature: SwiftProtobuf._ProtoNameProviding {
  private static let _protobuf_nameMap_bytecode: Swift.StaticString = "\u{0}\u{1}\u{0}ENUM_FEATURE_UNKNOWN\u{0}\u{1}\u{1}ENUM_FEATURE_VALUE1\u{0}\u{1}\u{2}ENUM_FEATURE_VALUE2\u{0}\u{1}\u{3}ENUM_FEATURE_VALUE3\u{0}\u{1}\u{4}ENUM_FEATURE_VALUE4\u{0}\u{1}\u{5}ENUM_FEATURE_VALUE5\u{0}\u{1}\u{6}ENUM_FEATURE_VALUE6\u{0}"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: _protobuf_nameMap_bytecode)
}
