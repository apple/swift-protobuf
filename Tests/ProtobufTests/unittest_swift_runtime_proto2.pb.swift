...
public struct ProtobufUnittest_Message2: ProtobufGeneratedMessage {
  ...
  private class _StorageClass {
    ...
    func decodeField(setter: inout ProtobufFieldDecoder, protoFieldNumber: Int) throws -> Bool {
      ...
      case 16: handled = try setter.decodeOptionalGroupField(fieldType: ProtobufUnittest_Message2.OptionalGroup.self, value: &_optionalGroup)
      case 18: handled = try setter.decodeOptionalMessageField(fieldType: ProtobufUnittest_Message2.self, value: &_optionalMessage)
      case 19: handled = try setter.decodeOptionalField(fieldType: ProtobufUnittest_Message2.Enum.self, value: &_optionalEnum)
      ...
      case 46: handled = try setter.decodeRepeatedGroupField(fieldType: ProtobufUnittest_Message2.RepeatedGroup.self, value: &_repeatedGroup)
      case 48: handled = try setter.decodeRepeatedMessageField(fieldType: ProtobufUnittest_Message2.self, value: &_repeatedMessage)
      case 49: handled = try setter.decodeRepeatedField(fieldType: ProtobufUnittest_Message2.Enum.self, value: &_repeatedEnum)
      ...
      case 85: handled = try setter.decodeMapField(fieldType: ProtobufMap<ProtobufString,ProtobufUnittest_Message2>.self, value: &_mapStringMessage)
      case 86: handled = try setter.decodeMapField(fieldType: ProtobufMap<ProtobufInt32,ProtobufBytes>.self, value: &_mapInt32Bytes)
      case 87: handled = try setter.decodeMapField(fieldType: ProtobufMap<ProtobufInt32,ProtobufUnittest_Message2.Enum>.self, value: &_mapInt32Enum)
      case 88: handled = try setter.decodeMapField(fieldType: ProtobufMap<ProtobufInt32,ProtobufUnittest_Message2>.self, value: &_mapInt32Message)
      default:
        handled = false
      }
      if handled {
    ...
    func traverse(visitor: inout ProtobufVisitor) throws {
      ...
      if !_mapStringMessage.isEmpty {
        try visitor.visitMapField(fieldType: ProtobufMap<ProtobufString,ProtobufUnittest_Message2>.self, value: _mapStringMessage, protoFieldNumber: 85, protoFieldName: "map_string_message", jsonFieldName: "mapStringMessage", swiftFieldName: "mapStringMessage")
      }
      ...
      if !_mapInt32Enum.isEmpty {
        try visitor.visitMapField(fieldType: ProtobufMap<ProtobufInt32,ProtobufUnittest_Message2.Enum>.self, value: _mapInt32Enum, protoFieldNumber: 87, protoFieldName: "map_int32_enum", jsonFieldName: "mapInt32Enum", swiftFieldName: "mapInt32Enum")
      }
      if !_mapInt32Message.isEmpty {
        try visitor.visitMapField(fieldType: ProtobufMap<ProtobufInt32,ProtobufUnittest_Message2>.self, value: _mapInt32Message, protoFieldNumber: 88, protoFieldName: "map_int32_message", jsonFieldName: "mapInt32Message", swiftFieldName: "mapInt32Message")
      }
  ...
  public enum OneOf_O: ExpressibleByNilLiteral, ProtobufOneofEnum {
    ...
    public mutating func decodeField(setter: inout ProtobufFieldDecoder, protoFieldNumber: Int) throws -> Bool {
      ...
      case 55:
        var value: Int32?
        handled = try setter.decodeOptionalField(fieldType: ProtobufSInt32.self, value: &value)
        if let value = value, handled {
      ...
      case 57:
        var value: UInt32?
        handled = try setter.decodeOptionalField(fieldType: ProtobufFixed32.self, value: &value)
        if let value = value, handled {
          self = .oneofFixed32(value)
        }
      case 58:
        var value: UInt64?
        handled = try setter.decodeOptionalField(fieldType: ProtobufFixed64.self, value: &value)
        if let value = value, handled {
          self = .oneofFixed64(value)
        }
      case 59:
        var value: Int32?
        handled = try setter.decodeOptionalField(fieldType: ProtobufSFixed32.self, value: &value)
        if let value = value, handled {
          self = .oneofSfixed32(value)
        }
      case 60:
        var value: Int64?
        handled = try setter.decodeOptionalField(fieldType: ProtobufSFixed64.self, value: &value)
        if let value = value, handled {
          self = .oneofSfixed64(value)
        }
      case 61:
        var value: Float?
        handled = try setter.decodeOptionalField(fieldType: ProtobufFloat.self, value: &value)
        if let value = value, handled {
      ...
      case 66:
        ...
        handled = try setter.decodeOptionalGroupField(fieldType: ProtobufUnittest_Message2.OneofGroup.self, value: &value)
        if let value = value, handled {
          self = .oneofGroup(value)
        }
      case 68:
        var value: ProtobufUnittest_Message2?
        handled = try setter.decodeOptionalMessageField(fieldType: ProtobufUnittest_Message2.self, value: &value)
        if let value = value, handled {
          self = .oneofMessage(value)
        }
      case 69:
        var value: ProtobufUnittest_Message2.Enum?
        handled = try setter.decodeOptionalField(fieldType: ProtobufUnittest_Message2.Enum.self, value: &value)
        if let value = value, handled {
  ...
  public struct OneofGroup: ProtobufGeneratedGroup {
    ...
    public mutating func _protoc_generated_decodeField(setter: inout ProtobufFieldDecoder, protoFieldNumber: Int) throws -> Bool {
      let handled: Bool
      switch protoFieldNumber {
      case 67: handled = try setter.decodeOptionalField(fieldType: ProtobufInt32.self, value: &a)
      case 167: handled = try setter.decodeOptionalField(fieldType: ProtobufInt32.self, value: &b)
      default:
        handled = false
      }
      if handled {
  ...
  public init(optionalInt32: Int32? = nil,
    ...
    optionalGroup: ProtobufUnittest_Message2.OptionalGroup? = nil,
    optionalMessage: ProtobufUnittest_Message2? = nil,
    optionalEnum: ProtobufUnittest_Message2.Enum? = nil,
    repeatedInt32: [Int32] = [],
    repeatedInt64: [Int64] = [],
    ...
    repeatedBytes: [[UInt8]] = [],
    repeatedGroup: [ProtobufUnittest_Message2.RepeatedGroup] = [],
    repeatedMessage: [ProtobufUnittest_Message2] = [],
    repeatedEnum: [ProtobufUnittest_Message2.Enum] = [],
    oneofInt32: Int32? = nil,
    oneofInt64: Int64? = nil,
    oneofUint32: UInt32? = nil,
    oneofUint64: UInt64? = nil,
    oneofSint32: Int32? = nil,
    oneofSint64: Int64? = nil,
    oneofFixed32: UInt32? = nil,
    oneofFixed64: UInt64? = nil,
    oneofSfixed32: Int32? = nil,
    oneofSfixed64: Int64? = nil,
    oneofFloat: Float? = nil,
    oneofDouble: Double? = nil,
    oneofBool: Bool? = nil,
    oneofString: String? = nil,
    oneofBytes: [UInt8]? = nil,
    oneofGroup: ProtobufUnittest_Message2.OneofGroup? = nil,
    oneofMessage: ProtobufUnittest_Message2? = nil,
    oneofEnum: ProtobufUnittest_Message2.Enum? = nil,
    ...
    mapStringMessage: Dictionary<String,ProtobufUnittest_Message2> = [:],
    mapInt32Bytes: Dictionary<Int32,[UInt8]> = [:],
    mapInt32Enum: Dictionary<Int32,ProtobufUnittest_Message2.Enum> = [:],
    mapInt32Message: Dictionary<Int32,ProtobufUnittest_Message2> = [:])
  {
    ...
    if !repeatedEnum.isEmpty {
      storage._repeatedEnum = repeatedEnum
    }
    if let v = oneofInt32 {
      storage._o = .oneofInt32(v)
    }
    if let v = oneofInt64 {
      storage._o = .oneofInt64(v)
    }
    if let v = oneofUint32 {
      storage._o = .oneofUint32(v)
    }
    if let v = oneofUint64 {
      storage._o = .oneofUint64(v)
    }
    if let v = oneofSint32 {
      storage._o = .oneofSint32(v)
    }
    if let v = oneofSint64 {
      storage._o = .oneofSint64(v)
    }
    if let v = oneofFixed32 {
      storage._o = .oneofFixed32(v)
    }
    if let v = oneofFixed64 {
      storage._o = .oneofFixed64(v)
    }
    if let v = oneofSfixed32 {
      storage._o = .oneofSfixed32(v)
    }
    if let v = oneofSfixed64 {
      storage._o = .oneofSfixed64(v)
    }
    if let v = oneofFloat {
      storage._o = .oneofFloat(v)
    }
    if let v = oneofDouble {
      storage._o = .oneofDouble(v)
    }
    if let v = oneofBool {
      storage._o = .oneofBool(v)
    }
    if let v = oneofString {
      storage._o = .oneofString(v)
    }
    if let v = oneofBytes {
      storage._o = .oneofBytes(v)
    }
    if let v = oneofGroup {
      storage._o = .oneofGroup(v)
    }
    if let v = oneofMessage {
      storage._o = .oneofMessage(v)
    }
    if let v = oneofEnum {
      storage._o = .oneofEnum(v)
    }
    ...
    if !mapInt32Message.isEmpty {
      storage._mapInt32Message = mapInt32Message
    }
  }
