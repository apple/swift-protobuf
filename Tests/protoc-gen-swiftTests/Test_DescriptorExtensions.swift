...
final class Test_DescriptorExtensions: XCTestCase {
    ...
    func testExtensionRanges() throws {
        ...
        let msgDescriptor2 = descriptorSet.descriptor(
            named: "swift_descriptor_test.MsgExtensionRangeOrderingWithFields"
        )!
        // Quick check of what should be in the proto file
        ...
        let msgDescriptor3 = descriptorSet.descriptor(
            named: "swift_descriptor_test.MsgExtensionRangeOrderingNoMerging"
        )!
        // Quick check of what should be in the proto file
    ...
    private func assertImports(
        ...
        func symbolsSections(importDirective: String, exportedImportDirective: String) -> String {
            let expectedExported =
                symbolsPerSection.exported.isEmpty
                ? ""
                : """
