...
test-plugin: build ${PROTOC_GEN_SWIFT}
	...
	@find _test -type f -name "*.pb.swift" -print0 \
	  | xargs -0 sed -i '' "s/Generated by .* and protoc-gen-swift .*./Generated by protoc and protoc-gen-swift./g"
...
reference: build ${PROTOC_GEN_SWIFT}
	...
	@find Reference -type f -name "*.pb.swift" -print0 \
	  | xargs -0 sed -i '' "s/Generated by .* and protoc-gen-swift .*./Generated by protoc and protoc-gen-swift./g"
...
regenerate-library-protos: build ${PROTOC_GEN_SWIFT}
	${GENERATE_SRCS} \
		...
		${LIBRARY_PROTOS}
	@find Sources/SwiftProtobuf -type f -name "*.pb.swift" -print0 \
	  | xargs -0 sed -i '' "s/Generated by .* and protoc-gen-swift .*./Generated by protoc and protoc-gen-swift./g"
...
regenerate-plugin-protos: build ${PROTOC_GEN_SWIFT}
	${GENERATE_SRCS} \
		...
		${PLUGIN_PROTOS}
	@find Sources/PluginLibrary -type f -name "*.pb.swift" -print0 \
	  | xargs -0 sed -i '' "s/Generated by .* and protoc-gen-swift .*./Generated by protoc and protoc-gen-swift./g"
...
regenerate-test-protos: build ${PROTOC_GEN_SWIFT}
	...
	@find Tests/SwiftProtobufTests -type f -name "*.pb.swift" -print0 \
	  | xargs -0 sed -i '' "s/Generated by .* and protoc-gen-swift .*./Generated by protoc and protoc-gen-swift./g"
...
regenerate-conformance-protos: build ${PROTOC_GEN_SWIFT}
	${GENERATE_SRCS} \
		...
		${CONFORMANCE_PROTOS}
	@find Sources/Conformance -type f -name "*.pb.swift" -print0 \
	  | xargs -0 sed -i '' "s/Generated by .* and protoc-gen-swift .*./Generated by protoc and protoc-gen-swift./g"
