...
extension UsesATransitively2: SwiftProtobuf.Message {
  public static let protoMessageName: Swift.String = "UsesATransitively2"
  #if _pointerBitWidth(_64)
    @_alwaysEmitIntoClient @inline(__always)
    private static var _protobuf_messageSchemaString: Swift.StaticString { "\0\u{10}\0\0\u{2}\0\0\0\0\0\u{2}\0\0\u{1}\0\0o\0\0\0\0\u{8}\0\0\0\0\u{2}\0\u{b}z\0\0\0\0\u{4}\0\0\u{1}\0\u{1}\0\u{e}\u{12}\0UsesATransitively2" }
  #elseif _pointerBitWidth(_32)
    @_alwaysEmitIntoClient @inline(__always)
    private static var _protobuf_messageSchemaString: Swift.StaticString { "\0\u{c}\0\0\u{2}\0\0\0\0\0\u{2}\0\0\u{1}\0\0o\0\0\0\0\u{8}\0\0\0\0\u{2}\0\u{b}z\0\0\0\0\u{4}\0\0\u{1}\0\u{1}\0\u{e}\u{12}\0UsesATransitively2" }
  #else
    #error("Unsupported platform")
  #endif
  @_alwaysEmitIntoClient @inline(__always)
  private static var _protobuf_reflectionData: Swift.StaticString { "0\0\0\0\0\u{1f}sm\u{1d}{u\u{1f}k<Llh\u{19}\u{1d}Y-wQ.($~\u{7}NFC{\\\u{1}\0" }
