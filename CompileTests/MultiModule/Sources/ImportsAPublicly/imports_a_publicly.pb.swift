...
extension ImportsAPublicly: SwiftProtobuf.Message {
  public static let protoMessageName: Swift.String = "ImportsAPublicly"
    ...
    private static let _protobuf_messageSchemaString: Swift.StaticString = "\0\u{c}\0\0\u{2}\0\0\0\0\0\u{2}\0\0\u{1}\0\0\u{b}\0\0\0\0\u{8}\0\0\0\0\u{2}\0\u{b}\u{c}\0\0\0\0\u{4}\0\0\u{1}\0\u{1}\0\u{e}\u{10}\0ImportsAPublicly"
  #else
