...
extension ImportsAPublicly: SwiftProtobuf.Message {
  public static let protoMessageName: Swift.String = "ImportsAPublicly"
    ...
    private static var _protobuf_messageSchemaString: Swift.StaticString { "\0\u{10}\0\0\u{2}\0\0\0\0\0\u{2}\0\0\u{1}\0\0\u{b}\0\0\0\0\u{8}\0\0\0\0\u{2}\0\u{b}\u{c}\0\0\0\0\u{4}\0\0\u{1}\0\u{1}\0\u{e}\u{10}\0ImportsAPublicly" }
  #elseif _pointerBitWidth(_32)
    @_alwaysEmitIntoClient @inline(__always)
    private static var _protobuf_messageSchemaString: Swift.StaticString { "\0\u{c}\0\0\u{2}\0\0\0\0\0\u{2}\0\0\u{1}\0\0\u{b}\0\0\0\0\u{8}\0\0\0\0\u{2}\0\u{b}\u{c}\0\0\0\0\u{4}\0\0\u{1}\0\u{1}\0\u{e}\u{10}\0ImportsAPublicly" }
  #else
    #error("Unsupported platform")
  #endif
  @_alwaysEmitIntoClient @inline(__always)
  private static var _protobuf_reflectionData: Swift.StaticString { "0\0\0\0\0\u{1f}sm\u{1d}\u{7}2\u{8}p\u{15}Xy\u{b}K&_/\u{1a}9\u{2}R\u{19}\u{12}##qf^\u{19}2\u{3}\0\0" }
